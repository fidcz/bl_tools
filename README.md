...
*提示: 如果是拼多多订单，可能需要10秒左右才能同步成功(2021-3-6:<u>拼多多使用隐私号码</u>)*
...
如果套餐不为1件，那么SKU内容为 "商品编号\*套餐\*数量"，例如20000123\*5\*10(商品编号20000123，套餐五件套，数量10，总共50件)**  
*提示: 订单显示未同步就稍后再试。这个功能仅限订单下只有一个商品*
...
### 天猫过审
> 输入订单号，由天猫自动审方通过这个待审核订单  
> 仅用于 **改套餐下单**、**以前没货，现在有货** 等各种可以通过的情况  
> 主要是可以不用离开自己电脑就能通过天猫自动审方了，~~懒得动啊！~~

> 教程:  
> 打开输入订单号，点击添加。完事(如下图)  
> ![天猫过审](https://gitee.com/fidcz/blyy_tools_update/raw/master/img/%E5%A4%A9%E7%8C%AB%E8%BF%87%E5%AE%A1.gif)  
...
> 可以把拼多多审方的浏览器藏起来  
> 打开拼多多审方浏览器，点一下隐藏  
> 隐藏后解锁"拼多多审方隐藏"页面，在里面可以看到隐藏的网页  
> "拼多多审方隐藏"页面里面的"显示拼多多审方"按钮即可恢复; 点移入可以重新移入  
