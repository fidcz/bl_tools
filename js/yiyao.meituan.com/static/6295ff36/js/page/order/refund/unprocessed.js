...
require(["module/general", "module/interface", "module/order/order_list", "module/order/warehouse_select", "util/utils"], function(e, t, n, o, r) {
    "use strict";
    function u(e) {
        n.init({
            queryUrl: CommConstants.newCategory ? t.order.sc.getUnprocessedRefund : t.order.getUnprocessedRefund,
            getQueryFields: function() {
                var e = {};
                return CommConstants.newCategory ? (e.status = a,
                localStorage.setItem("refundStatus", a)) : (e.getNewVo = 1,
                e.refundStatus = 1),
                -1 !== s.warehouseId && (e.warehouseId = s.warehouseId),
                e
            },
            dataGotCb: function(t) {
                var n = t.data.toRefundCount || 0;
                parent.RefundOrder.handleRefundApply(n),
    ...
    o.methods.refundInit = u;
    var s = new Vue(o)
      , a = +(localStorage.getItem("refundStatus") || 0);
    CommConstants.newCategory && ($(".J-refund-status").find("input[value=" + a + "]").prop("checked", !0),
    $(".J-refund-status").show().find("input").click(function() {
        a = $(this).val(),
        sessionStorage && sessionStorage.setItem("refundStatus", a),
        u()
    }),
    $("#status-2").parent().remove()),
    parent.loadRefundOrderList = u,
    u(),
    r.reportMC("b_shangou_online_e_5a8kk2jr_mc", "c_o1skm0jl", null, null, {
        button_nm: "待处理"
    }),
    r.reportPV("c_o1skm0jl", {
        des: "PC退单"
    })
});
define("page/order/refund/unprocessed", function() {});
