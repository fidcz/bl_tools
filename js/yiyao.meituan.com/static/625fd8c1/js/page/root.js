define('module/cookie', [], function() {
    ...
    function n(e, o, n) {
        if (n) {
            var t = new Date;
            t.setTime(t.getTime() + 1e3 * n), document.cookie = e + "=" + encodeURIComponent(o) + "; path=/; expires=" + t.toUTCString()
        } else document.cookie = e + "=" + encodeURIComponent(o) + "; path=/"
    }
...
define('util/ubl', ["module/cookie"], function(e) {
    ...
    function t() {
        var e = (new Date).getTime(),
            ...
            i = e - t > 18e5 ? !0 : !1;
        return i && localStorage.setItem("ad_ubl_sessionid", e), localStorage.getItem("ad_ubl_sessionid")
    }
    $(document).delegate('.ubl[data-ubl-action="click"]', "click", function() {
        ...
        $.extend(!0, d, c), Analytics("event", d), "function" == typeof mta && mta("count", "click." + l)
    });
    ...
    return Analytics("set", {
    ...
    }), localStorage.setItem("REF_PAGE_ID", i), window.LXAnalyticsSG = function(e, t, i) {
        var l = {
            nm: "mge",
            val_cid: i.cid,
            val: {
        ...
        $.extend(!0, l.val.lab, i), Analytics("event", l)
    }, {
...
define('util/template', [], function() {
    ...
    return function(t, n) {
        if (e[t]) return n ? e[t](n) : e[t];
        t = t.replace(/\/\*.*?\*\/|\/\/.*?[\n\r\t]/g, "").replace(/[\r\t\n]/g, " ");
        var a = {},
            i = "var ",
            o = t.match(/<%(.*?)%>/g).join(",").match(/[\_\$a-zA-Z]+[0-9]*/g);
        ! function(e) {
            for (var t = e.length, n = ""; t--;) n = e[t], n && !r(n) && (a.hasOwnProperty(n) || (i += n + "= __data." + n + ",", a[n] = !0))
        }(o);
...
require.config({
    ...
    return {
        ...
        getTime: function(e, t) {
            ...
            for (var n in o) new RegExp("(" + n + ")").test(e) && (e = e.replace(RegExp.$1, 1 == RegExp.$1.length ? o[n] : ("00" + o[n]).substr(("" + o[n]).length)));
            return e
        },
        changeDate: function(e) {
            ...
            var r = t.getFullYear(),
                o = t.getMonth() + 1,
                n = t.getDate();
            return 10 > o && (o = "0" + o), 10 > n && (n = "0" + n), r + "-" + o + "-" + n
        },
        getOffsetDays: function(e, t) {
            var r = new RegExp("^\\d{4}-\\d{1,2}-\\d{1,2}( \\d{1,2}:\\d{1,2}:\\d{1,2})?$");
            if (!r.test(e) || !r.test(t)) return null;
            var o = new RegExp("^\\d{4}-\\d{1,2}-\\d{1,2}$");
            o.test(e) && (e += " 00:00:00"), o.test(t) && (t += " 23:59:59");
            var n = new Date(e),
                i = new Date(t);
            if (isNaN(n)) {
                var a = e.split(/[- :]/),
                    c = t.split(/[- :]/);
                n = new Date(a[0], a[1] - 1, a[2], a[3], a[4], a[5]), i = new Date(c[0], c[1] - 1, c[2], c[3], c[4], c[5])
            }
            var s = n.getTime(),
                l = i.getTime();
        ...
        formatSecond: function(e, t, r) {
            if (0 >= e) return '<strong class="time">00</strong>:<strong class="time">00</strong>:<strong class="time">00</strong>';
            if (r) {
            ...
            var t = this,
                ...
                i = function() {
                    if (!document.body.contains || document.body.contains(e.jQelem[0])) {
                        ...
                        e.countStyle ? (o = e.time - a, e.midTime && o <= e.midTime && "function" == typeof e.midCb && (n || (e.midCb(), n = !0))) : (o = e.time + a, e.midTime && o >= e.midTime && "function" == typeof e.midCb && (n || (e.midCb(), n = !0)));
                        var c = t.formatSecond(0 > o ? 0 : o, e.chn, e.needDay);
                        return e.jQelem.html(e.txt.replace("{time}", c)), 0 > o ? (o = 0, e.jQelem.trigger("endCount"), void("function" == typeof e.cb && e.cb())) : void setTimeout(i, 1e3)
                    }
                };
            i()
        },
        setStorage: function(e, t) {
            ...
            r ? (t = String(t), r.setStorage(e, encodeURIComponent(t))) : localStorage.setItem(e, t)
        },
        getStorage: function(e) {
            var t, r = window.wmSystemApi;
            return r ? (t = r.getStorage(e), t && (t = decodeURIComponent(r.getStorage(e)))) : t = localStorage.getItem(e), t
        },
        ...
        graphicPrintAfterOrderConfirm: function(e, t, r) {
            ...
            if ("" + o.auto == "1") {
                ...
                n && i ? (this.graphicPrint(t, r, o), this.reportMC("b_shangou_online_e_46grpax8_mc", "c_shangou_online_e_vbzrhmnc")) : (this.reportMC("b_shangou_online_e_28cu7gpz_mc", "c_shangou_online_e_vbzrhmnc"), this.ajaxWarn("接单失败", {
                    tag1: n ? "接口调用成功" : "接口调用失败"
                }, "utils.graphicPrintAfterOrderConfirm"))
            }
        },
        graphicPrint: function(e, t, r) {
            window.nw && (console.log("接单后自动A4打印"), window.nw.Window.open(location.protocol + "//" + location.host + "/page/printer/graphic/template?orderId=" + t + "&wmPoiId=" + e + "&copies=" + r.copies + "&printer=" + encodeURIComponent(r.printer) + "&mode=auto&callFrom=pcapi", {
                show: !1
            }))
        },
        ...
        getVerifyCode: function(e, t, r) {
            ...
            e.off("endCount").on("endCount", function() {
                e.text("免费获取手机动态码"), e.removeAttr("disabled")
            }), r(function() {
                e.attr("disabled", !0), o.countDown({
                    countStyle: !0,
                    time: 60,
                    jQelem: e,
                    txt: t
        ...
        changeImgUrl: function(e, t) {
            return e.indexOf("/0.0.o") > -1 && (e = e.replace("/0.0.o", "")), localStorage.getItem("hasSupportWebp") && (e += ".webp"), e += "@" + t + "w"
        },
        ...
        reportPV: function(t, r, o) {
            if (!t) return void console.error("pv未填写cid");
            var n = {
        ...
        reportMV: function(t, r, o, n, i) {
            if (!t) return void console.error("mv未填写bid");
            var a = {
                poi_id: e.getCookie("wmPoiId"),
                custom: $.extend({}, o)
            };
        ...
        reportMC: function(t, r, o, n, i) {
            if (!t) return void console.error("mc未填写bid");
            var a = {
                poi_id: e.getCookie("wmPoiId"),
                custom: $.extend({}, o)
            };
        ...
        addJsError: function(t, r) {
            console.warn(t), window.Owl && (r && "object" == typeof r || (r = {}), r.wmPoiId = e.getCookie("wmPoiId"), r.acctId = e.getCookie("acctId"), window.Owl.addError(t, {
                level: "warn",
                combo: !1,
                tags: r
            }))
        ...
        ajaxWarn: function(t, r, o) {
            console.warn(t, o), window.Owl && (r && "object" == typeof r || (r = {}), r.userId = e.getCookie("wmPoiId"), window.Owl.addError("string" == typeof o ? {
                name: t,
                msg: o
            } : t, {
                level: "warn",
        ...
        versionCompare: function(e, t) {
            function r(e, t) {
                return "number" != typeof e && (e = 0), "number" != typeof t && (t = 0), e > t ? n : t > e ? i : a
            }
            var o, n = 1,
                i = -1,
                a = 0,
                c = String(e).split(".").map(function(e) {
                    return parseInt(e)
                }),
            ...
            for (var u = 0; l > u && (o = r(c[u], s[u]), o == a); u++);
            return o
        },
        ...
        customReport: function(e, t) {
            if (Owl && Owl.metricManager) {
                ...
                t && r.setTags(t), r.setMetric(e, 1), r.report()
            }
        },
        detectCrash: function() {
            if (window.localStorage && window.performance && window.performance.memory) {
                ...
                r && t.customReport(e, JSON.parse(r)), window.crash_heartbeat = function() {
                    r = {
        ...
        s = function(e, t) {
            ...
            for (var i = a.querySelectorAll("a"), n = 0, s = i.length; s > n; n++) {
                ...
                if (-1 === o.href.indexOf("javascript") || -1 === i[n].className.indexOf("page-jump")) {
                    var r = i[n].href;
                    i[n].href = "javascript:void(0);", i[n].className += " page-jump J-close-tip", i[n].setAttribute("data-url", r)
                }
            }
            return e = a.innerHTML, $('<div class="alert alert-single wm-tips-append" role="alert"><div class="b-tip">' + e + '</div><span class="wm-tips-know color-link font-12 cursor J-close-tip" data-dismiss="alert" aria-label="Close">我知道了</span><div class="wm-tips-icon"></div></div>')
        },
        o = function(e, t, a, i) {
            var o = n(),
                l = s(e, t),
                c = $("#main-container");
            $("#aside");
            o && (o.empty(), l.appendTo(o).slideDown(), "function" == typeof a && a(l), l.find(".J-close-tip").click(function() {
                r(l, c), "function" == typeof i && i()
            }))
        },
        r = function(e, t) {
            var a;
        ...
        f = function(e) {
            ...
            if (r) {
                ...
                if (a > 0) {
                    ...
                    d += -1 == p ? "临近送达时间" : "需" + s + "分钟内送达", d += "，请注意备货并配送，点击查看</a>", 0 === c.size() ? o(d, "J-pre-order-notify", function(e) {
                        e.data("total", t), e.data("span", a), e.data("time", s)
                    }) : (t != c.data("total") || a != c.data("span") || s != c.data("time")) && (l(c, d), c.data("total", t), c.data("span", a), c.data("time", s))
                } else c.size() > 0 && c.remove()
            }
        };
    return {
        assembleNormalTip: o,
...
define('module/sys_api', ["module/cookie"], function(e) {
    ...
    if (n) {
        var o = function(o) {
            if (t.code >= 4010) n.getDeviceReportData().then(function(e) {
                o({
                    sys: e.sys,
                    usb: e.usb,
                    appVersion: t.code
                ...
                var a = function(e, o) {
                        ...
                        n.createCommand(function(e) {
                            "out" === e.type && (a += e.str), "close" === e.type && o && o(a)
                    ...
                    c = function(t) {
                        ...
                        a(p.command, function(t) {
                            if (p.data = p.deal ? p.deal(t) : t, ++s < i.length) c(s);
                            else {
                                var a = {
                                ...
                                a.appVersion = f && f.code || 0, "function" == typeof o && o(a)
                            }
                        })
                    };
                c(s)
...
define('module/page_jump', [], function() {
    ...
    return $(document).delegate(".page-jump", "click", function() {
        ...
        "medicine" == window.CommConstants.shopCate && n && (a = n), i && localStorage.setItem("selectLabel", i), o.location.hash = a, a === e && "function" == typeof o.goPager && o.goPager()
    }), {
        go: function(o) {
            var e = t(),
                a = e.location.hash.substr(1),
                n = o;
            if (e.location.hash = o, n === a) {
                var i = localStorage.getItem("nojump");
                localStorage.removeItem("nojump"), "true" != i && e.location.reload()
            }
        },
...
define('widgets/normal_dialog', ["module/page_jump"], function(a) {
    return function(n) {
        ...
        if (c += n.noHeader ? '<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: absolute;top: 10px;right: 10px;z-index: 999;"><span aria-hidden="true">×</span></button>' : '<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button><h5 class="modal-title" id="normalModalLabel">' + n.title + "</h5></div>", c += '<div class="modal-body">' + n.content + '</div><div class="modal-footer">' + (n.btns[0] ? '<button type="button" class="btn btn-primary J-confirm ' + (n.btns[0]["class"] || "") + '">' + n.btns[0].txt + "</button>" : "") + (n.btns[1] ? '<button type="button" class="btn btn-default J-cancel ' + (n.btns[1]["class"] || "") + '" data-dismiss="modal">' + n.btns[1].txt + "</button>" : "") + "</div>", d) {
            c += '<div class="J-modal-banner css-modal-banner">' + l + '<div class="offset">';
            for (var b = 0; d > b; b++) c += '<span data-index="' + b + '" class="JS-banner-offset"></span>';
            c += "</div></div>"
        }
        c += "</div></div></div>";
        var u = null,
        ...
        m.find(".J-confirm").on("click", function() {
            n.btns[0] && n.btns[0].fn ? n.btns[0].fn() : "", t()
        }), m.find(".J-cancel").on("click", function() {
            n.btns[1] && n.btns[1].fn ? n.btns[1].fn() : "", m.modal("hide"), t()
        }), m.on("hide.bs.modal", function(a) {
            n.onClose && n.onClose(), m.remove(), t()
        });
        ...
        if (d && r) {
            ...
            g.eq(0).addClass("active"), h.on("click", function() {
                var n = $(this).data("link"),
                    t = $(this).data("resourceId");
                n && (a.go(n), r.reportMC("b_shangou_online_e_enjmt6gt_mc", v, {
                    resourceId: t
                }))
            });
            var C = 1,
            ...
            u = setInterval(function() {
                C === d && (C = 0, _ = !1), g.removeClass("active"), g.eq(C).addClass("active"), s(C);
                var a = -78 * C;
                p.css("transform", "translateY(" + a + "px)"), C++
            }, e), g.on("click", function() {
                C = $(this).data("index"), g.removeClass("active"), $(this).addClass("active");
                var a = -78 * C;
                p.css("transform", "translateY(" + a + "px)")
            }), s(0)
        }
        return m.modal("show"), f.css("margin-top", ($(window).height() - f.height()) / 2), m
    }
});
define('widgets/get_poilist', ["util/utils"], function(o) {
    function i(i, a) {
        a = a || {}, "function" != typeof i && (i = function() {});
        var s = o.getLocalAllPoiList();
        a.force || !t.hasLoadPoiList && !t.isLoadingPoiList || !s ? (t.isLoadingPoiList = !0, $.ajax({
            url: "/api/poi/poiList",
            type: "POST",
            success: function(s) {
                if (0 === s.code) {
                    ...
                    i(s.data), CommConstants.waimai_e_poi_list = s.data, getShopCate && (CommConstants.shopCate = getShopCate(CommConstants.waimai_e_wmPoiId)), t.hasLoadPoiList = !0, t.isLoadingPoiList = !1
                } else localStorage.removeItem("localAllPoiList"), t.isLoadingPoiList = !1, a.showError !== !1 && o.showTip("加载门店列表失败，请稍后重试")
            },
            error: function() {
                localStorage.removeItem("localAllPoiList"), t.isLoadingPoiList = !1, a.showError !== !1 && o.showTip("加载门店列表失败，请稍后重试")
            }
        })) : i(s || [])
    }
    var t = window;
    return top !== self ? t = parent : (localStorage.removeItem("localAllPoiList"), t.hasLoadPoiList = !1, t.isLoadingPoiList = !1), i
});
...
define("module/root/custom_menu", ["module/cookie"], function(e) {
    var t = location.host,
        o = "//portal-portm.meituan.com/test/shangou/hot-replace/menu"; - 1 === t.indexOf("test") && -1 === t.indexOf("st") && (o = "//portal-portm.meituan.com/shangou/hot-replace/menu");
    var n = null,
        ...
        r = function(e) {
            ...
            if (t)
                if (-1 == i) {
                    if (n.all) return n.all[t]
                } else if (n.single) return n.single[t]
        };
    return u(), {
        init: u,
        getCustomHash: r
...
define('module/root/head_nav', ["util/ubl", "module/cookie", "widgets/tips_append", "module/interface", "util/utils", "module/sys_api", "module/page_jump", "widgets/normal_dialog", "widgets/get_poilist", "module/root/account_role_permission", "module/root/custom_menu"], function(t, e, i, a, o, s, n, l, c, r, u) {
    ...
    function p() {
        var t = [];
        $.each(S, function(e, i) {
            e > 19 || (-1 == i.id ? t.push('<li id="-1">' + i.poiName + "</li>") : t.push(m(i)), I.empty().html(t.join("")))
        })
    }
    ...
    function m(t) {
        var e = "",
            ...
            l = "",
            c = "";
        return i = 0 === t.status ? "待设置" : t.businessDesc, "营业中" !== i && (a = "no-open"), (10 === s || 20 === s) && (20 === s ? l = "/static/625fd8c1/imgs/kanOver.webp" : "v1" === n ? l = "/static/625fd8c1/imgs/kanV1.webp" : "v2" === n ? l = "/static/625fd8c1/imgs/kanV2.webp" : "v3" === n && (l = "/static/625fd8c1/imgs/kanV3.webp"), c = '<img src="' + l + '" class="kangaroo-status">'), e = '<li id="' + t.id + '" class="' + a + '" title="' + t.poiName + '">' + c + "<span>" + t.poiName + '</span><b class="font-12">' + i + "</b></li>"
    }
    ...
    function _(t) {
        return o.checkTag(t) || !t ? (o.showTip("输入不能为空或包含特殊字符"), !1) : !0
    }

    function d(t) {
        if (CommConstants.IS_LIANSUO && !/^1\d{3,10}$/.test(t)) return void o.showTip("请输入手机号查询");
        var e = "",
            i = Math.random();
        e = "/v2/order/history/r/search?searchItem=" + f(t, "g") + "&random=" + i, k.tagList && k.tagList.length && (e = C + "/searchItem=" + f(t, "g") + "&random=" + i), document.location.hash = e
    }
    var g, b;
    s && (g = s.sys, b = s.appInfo);
        ...
        k = new Vue({
            ...
            methods: {
                ...
                confirmSearch: function(t) {
                    if (M && M.val(""), this.tagList && this.tagList.length && void 0 !== t.tagId) {
                        var e = Math.random(),
                            i = C + "/tagId=" + t.tagId + "&random=" + e;
                        this.currentTag = t.tagId, this.showSearchTag = !1, document.location.hash = i
                    }
                }
            }
        }),
    ...
    $(".J-change-poi-wrapper").on("mouseenter", function() {
            ...
            if ("" == $.trim(t)) p();
                ...
                }), 0 == e.length && e.push("<li>没有搜到相关的门店</li>"), I.empty().html(e.join(""))
            }
        }),
        function() {
            var t = function() {
                    ...
                    success: function(e) {
                        if (0 === e.code) {
                            var i = e.data || {},
                                ...
                                l = "",
                                c = "";
                            $(".J-ad-url").attr("data-url", n), (10 === a || 20 === a) && (20 === a ? (l = "/static/625fd8c1/imgs/kanOver.webp", c = "您的袋鼠店长已过期，去续费") : (t.removeClass("box J-box"), c = "袋鼠店长 - " + s, "v1" === o ? l = "/static/625fd8c1/imgs/kanV1.webp" : "v2" === o ? l = "/static/625fd8c1/imgs/kanV2.webp" : "v3" === o && (l = "/static/625fd8c1/imgs/kanV3.webp"), t.attr("data-original-title", c).tooltip()), $(".J-kangaroo-home img").attr("src", l), $(".J-kangaroo-home").show(), $('.J-wm-poi-list li[id="' + v + '"] img').attr("src", l))
                        }
                    }
                })
            };
            t(), window.addEventListener("message", function(e) {
                var i = e.data || {};
                "update-kangaroo-rights" === i.action && (t(), c(function(t) {
                    S = t
                }, {
                    force: !0,
                    showError: !1
            ...
            S.forEach(function(t) {
                if (t.id == e) {
                    var i = t.id,
                        a = t.status,
                        o = t.poiName.replace(/[\r\n]/gi, ""); - 1 !== o.indexOf("'") && (o = o.replace(/'/g, "\\'")), selectCurrentPoi(i, o, "", a)
                }
    ...
    $(".J-change-status-wrapper").on("mouseenter", function() {
        y = setTimeout(function() {
            $.post(a.common.getBusinessStatus, {
                ...
                0 == t.code ? (J(t), o.reportMV("b_waimai_e_0xagmzhd_mv", "c_waimai_e_fa4ps4ng", {
    ...
    $(".J-box").hover(function() {
        ...
        $(this).removeClass("show"), clearTimeout(P)
        ...
        if (n != t && (localStorage.setItem("fromPoiChange", !0), (-1 == t || -1 == n) && (s = u.getCustomHash(location.hash.substr(1)))), 0 > t) return e.setCookie("wmPoiId", t, new Date((new Date).getTime() + 2592e6).toUTCString()), e.delCookie(""), s && (document.location.hash = s), void location.reload(!0);
        if (e.setCookie("isOfflineSelfOpen", 0 == o ? 1 : 0), $("#select_poi_button_text").text(i), e.setCookie("wmPoiId", t, new Date((new Date).getTime() + 2592e6).toUTCString()), e.setCookie("wmPoiName", i), e.setCookie("shopCategory", ""), e.setCookie("logistics_support", ""), a) document.location.hash = a;
        else {
                        ...
                        if (0 === e.code) {
                            ...
                            if (-1 === r) var f = l({
                                ...
                                btns: [{
                                    txt: "设置商品",
                                    fn: function() {
                                        n.go("/v2/shop/productManage"), f.modal("hide")
                                    }
                                }, {
                                    txt: "稍后设置",
                                    fn: function() {
                            ...
                            else $("#select_poi_status_button_text").text(c)
                        } else o.showTip(e.msg, "error");
                        i.modal("hide")
                    })
                }
            }, {
    ...
    var J = function(t) {
        ...
        $("#J-business-hour").text("营业时间：" + s), $("#select_poi_status_button_text").text(l), $("#wmPoiStatusDiv").html("");
        var h = CommConstants.shopCategoryObj.shopG;
        w = t.hasSpecialShippingTime, t.hasSpecialShippingTime && 0 === $(".J-change-status-wrapper .notice").length ? $('<span class="notice"><i></i></span>').insertAfter("#select_poi_status_button_text") : t.hasSpecialShippingTime || $(".J-change-status-wrapper .notice").remove();
        ...
        if (t.statusDescInfo) {
            var g = 3 == i || 1 == i && 4 == a ? " block-warn" : "",
                ...
                v = "",
                C = !0;
            "food" == CommConstants.shopCate || r.getPermission(3001) || (C = !1), 3 == i && (void 0 === c || 0 === c || 2 === c ? (b = '<li class="clearfix">' + d + '<p class="pull-left status-tip">恢复营业后，系统会根据营业时间自动切换营业中、已打烊状态。</p></li>', C = !1) : (1 === c || 3 === c) && (b = '<li class="clearfix"><button class="pull-right btn btn-primary btn-sm unable" disabled>恢复营业</button><p class="pull-left status-tip">提前恢复营业需联系业务经理。</p></li>')), 1 == i && (b = '<li class="clearfix">' + f + '<p class="pull-left status-tip">停业后，门店将不再接收新订单，不再会自动恢复营业。</p></li>', (2 == a || 4 == a) && (v = '<li class="clearfix">' + _ + '<p class="pull-left status-tip">如您期望调整当前营业状态，可更改营业时间、预订设置</p></li>')), C && ($("#J-business-hour").append('<span class="J-goto-shopinfo edit"><i class="fa fa-edit"></i>编辑</span>'), $("#J-business-hour").find(".J-goto-shopinfo").bind("click", function() {
        ...
        if (t.hasSpecialShippingTime) {
            ...
            T.slice(0, 2).forEach(function(t) {
            ...
            }), $("#wmTempBusinessTimeDiv").html('<hr><li class="clearfix"><span class="important-notice"><i></i>重要通知</span></li><li class="clearfix"><p>' + t.importantNotice + '</p><p class="mb5">配送站近期营业时间安排：</p>' + k + '<a class="notice-detail-url" href="javascript:void(0)">查看完整通知</a></li>'), $("#wmTempBusinessTimeDiv").find(".notice-detail-url").bind("click", function() {
                ...
                if (0 == i.indexOf("http")) {
                    ...
                    n += $.param(a), i = s[0] + n + (s && s.length > 1 ? "#" + s[1] : "")
                }
                window.frames.hashframe.location = i, setTimeout(function() {
                    $(".J-main-menu").find(".active").removeClass("active")
                }, 20)
            })
        } else $("#wmTempBusinessTimeDiv").html("")
    };
    b && b.code >= 30 ? (setTimeout(function() {
        try {
            var t = g.getCache("report_lastReportTime");
            (!t || (new Date).getTime() - parseInt(t) > 6048e5) && (g.setCache("report_lastReportTime", (new Date).getTime().toString()), g.flushCache(), s && s.getSysInfo(h))
        } catch (e) {}
    }, 6e5), Analytics("event", {
        nm: "mge",
        val: {
    ...
    })) : localStorage.getItem("info_reported") || (h({}), localStorage.setItem("info_reported", !0)), $("#top-nav").delegate(".j-view-orderstat", "click", function() {
        var t = "/v2/campaign/statistics";
        document.location.hash = t
    });
    var M = $(".J-search");
    CommConstants.IS_LIANSUO && M.attr("placeholder", "请输入手机号查询"), M.on("click", function(t) {
        k.showSearchTag = !k.showSearchTag
    }), M.keyup(function(t) {
        if (13 == t.keyCode) {
            var e = f($(this).val(), "g");
            _(e) ? d(e) : "", k.showSearchTag = !1
        }
        ...
        var t = $(this).index();
        0 === t && o.reportMC("b_shangou_online_e_sjppxg34_mc", "c_shangou_online_e_22anofv7"), 1 === t && o.reportMC("b_shangou_online_e_ln6ooa1b_mc", "c_shangou_online_e_22anofv7"), 3 === t && o.reportMC("b_shangou_online_e_40ui9u2r_mc", "c_shangou_online_e_22anofv7")
...
define('module/root/audio', ["util/utils"], function(e) {
    ...
    if (i && i.code < 4e3);
        ...
        var o = e.getStorage("audioVolume") || 1,
            n = function(e) {
                this.type = e, this.audioDOMObj = document.getElementById(e + "-audio"), this.audioObj = null, this.jQaudioDOMObj = $(this.audioDOMObj);
                var a = this.jQaudioDOMObj.data("loop");
                switch (this.audioSrc = this.jQaudioDOMObj.data("src"), this.loop = -1 === a ? 1 / 0 : a, this.isPlaying = !1, this.level = 0, e) {
                    case "neworder":
                        this.level = 1;
                        break;
                    case "cancel":
        ...
        n.prototype.audioPlay = function() {
            ...
            for (var a in window.audioControls) {
                ...
                if (i.level < this.level && (i.isPlaying || i.audioDownloading)) return;
                i.level > this.level && (i.isPlaying || i.audioDownloading) && i.audioStop()
            }
            if (this.audioObj) {
                if (this.isPlaying) return;
                e.looped = 0, e.audioObj.addEventListener("pause", e.pauseFunc, !1), e.safePlay(), e.isPlaying = !0
            } else {
                e.looped = 0, e.audioDownloading = !0;
                var n = new Audio;
                n.preload = "auto", e.playFunc = function() {
                    e.audioObj = n, e.audioObj.volume = o, e.isPlaying = !0, e.audioDownloading = !1, e.safePlay()
                }, n.addEventListener("canplaythrough", e.playFunc, !1), e.pauseFunc = function() {
                    e.looped++, e.isPlaying = !1, e.looped < e.loop ? e.safePlay() : e.audioStop()
                }, n.addEventListener("pause", e.pauseFunc, !1), n.src = "/static/media/" + this.audioSrc
            }
        }, n.prototype.audioStop = function(e) {
            var a = this,
                i = function() {
                    a.isPlaying = !1, a.audioDownloading = !1, a.audioObj && (a.audioObj.removeEventListener("canplaythrough", a.playFunc), a.audioObj.removeEventListener("pause", a.pauseFunc), a.audioObj.pause(), a.audioObj.currentTime = 0)
                };
    ...
    if (a && a.code < 4e3) {
        var o = e.getStorage("audioVolume") || 1,
            n = function(e) {
                ...
                switch (this.audioSrc = this.jQaudioDOMObj.data("src"), this.loop = -1 === i ? 1 / 0 : i, this.isPlaying = !1, this.level = 0, e) {
                    case "neworder":
                        this.level = 1;
                        break;
                    case "cancel":
        ...
        n.prototype.audioPlay = function() {
            ...
            for (var i in window.audioControls) {
                ...
                if (a.level < this.level && (a.isPlaying || a.audioDownloading)) return;
                a.level > this.level && (a.isPlaying || a.audioDownloading) && a.audioStop()
            }
            this.isPlaying || (e.looped = 0, e.RealAudioPlay())
        }, n.prototype.RealAudioPlay = function() {
            var e = this;
            e.audioDownloading = !0;
            var i = new Audio;
            i.preload = "auto", e.playFunc = function() {
                e.audioObj = i, e.audioObj.volume = o, e.isPlaying = !0, e.audioDownloading = !1, e.audioObj.play()
            }, i.addEventListener("canplaythrough", e.playFunc, !1), e.pauseFunc = function() {
                e.looped++, e.isPlaying = !1, e.looped < e.loop ? e.RealAudioPlay() : e.audioStop()
            }, i.addEventListener("pause", e.pauseFunc, !1), i.src = "/static/media/" + this.audioSrc
        }, n.prototype.audioStop = function(e) {
            var i = this,
                a = function() {
                    i.isPlaying = !1, i.audioDownloading = !1, i.audioObj && (i.audioObj.removeEventListener("canplaythrough", i.playFunc), i.audioObj.removeEventListener("pause", i.pauseFunc), i.audioObj.pause(), i.audioObj.currentTime = 0)
                };
...
require.config({
    ...
    window.wmPrinterApi, i && i.getAppInfo && i.getAppInfo();
    return new function() {
...
define('util/code', [], function() {
    return new function() {
        this.allASCII = function(r) {
            ...
            return !0
        }, _keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", this.base64Encode = function(r) {
            if (!r) return "";
            var e, t, n, o, a, c, f, h = "",
                d = 0;
            for (r = _utf8_encode(r); d < r.length;) e = r.charCodeAt(d++), t = r.charCodeAt(d++), n = r.charCodeAt(d++), o = e >> 2, a = (3 & e) << 4 | t >> 4, c = (15 & t) << 2 | n >> 6, f = 63 & n, isNaN(t) ? c = f = 64 : isNaN(n) && (f = 64), h = h + _keyStr.charAt(o) + _keyStr.charAt(a) + _keyStr.charAt(c) + _keyStr.charAt(f);
            return h
        }, this.base64Decode = function(r) {
            if (!r) return "";
            var e, t, n, o, a, c, f, h = "",
                d = 0;
            for (r = r.replace(/[^A-Za-z0-9\+\/\=]/g, ""); d < r.length;) o = _keyStr.indexOf(r.charAt(d++)), a = _keyStr.indexOf(r.charAt(d++)), c = _keyStr.indexOf(r.charAt(d++)), f = _keyStr.indexOf(r.charAt(d++)), e = o << 2 | a >> 4, t = (15 & a) << 4 | c >> 2, n = (3 & c) << 6 | f, h += String.fromCharCode(e), 64 != c && (h += String.fromCharCode(t)), 64 != f && (h += String.fromCharCode(n));
            ...
            for (var e = "", t = 0, n = c1 = c2 = 0; t < r.length;) n = r.charCodeAt(t), 128 > n ? (e += String.fromCharCode(n), t++) : n > 191 && 224 > n ? (c2 = r.charCodeAt(t + 1), e += String.fromCharCode((31 & n) << 6 | 63 & c2), t += 2) : (c2 = r.charCodeAt(t + 1), c3 = r.charCodeAt(t + 2), e += String.fromCharCode((15 & n) << 12 | (63 & c2) << 6 | 63 & c3), t += 3);
            return e
        }
    }
});
define('module/printer_33', ["util/code"], function(utils) {
    function WmPrinter() {
        function _WmPrinterWrapper(t) {
            function n(t) {
                var n = t ? "array" == typeof t ? t : t.split(",") : [],
                    r = [];
                for (var e in n) r.push(n[e].trim());
                return r
            }
            ...
            function r(t) {
                ...
                return n.align && r.push(n.align), n.vAlign && r.push(n.vAlign), n.font && r.push(n.font), r
            }
            ...
            function e(t) {
                ...
                return !s && l && e("L"), !a && l && e("B"), c || e("CHW"), l = !1, i
            }
            var i, a = t,
                o = "L",
                u = "B",
            ...
            this.prop = function(t) {
                ...
                if (a.test) return i = a.test().success;
                ...
                if (t) {
                    ...
                    t.font && (e.font = utils.base64Decode(t.font)), this.set(e)
                }
                var i = a.init();
                return c = !1, l = !1, o = "L", u = "B", f = "CHW", i.success
            }, this.unknown = function() {
                return a.unknown ? a.unknown() : !1
            }, this.pageEnd = function(t) {
                a.pageEnd && a.pageEnd(t)
            }, this.cmd = function(t, r) {
                for (var i = null !== r && void 0 != r ? n : e, s = i(t), o = 0, u = s.length; u > o; o++) a.cmd(s[o], r);
                return this
            }, this.pt = function(t, n) {
                return this.cmd(n), !String.empty(t) && (a.data(t), c = !1), this
            }, this.ptf = function(t) {
                var n = -1,
                ...
                return this.pt(t, n), this.cmd("PRINT")
            }, this.ptfl = function(t) {
                return this.ptf.apply(this, arguments), this.ptl()
            }, this.pts = function(t, n, r) {
                n || (n = this.width()), 1 > n && (n = parseInt(this.width() * n)), "object" != typeof t && (t = {
                    "char": (t || "-").toString(),
                    text: "",
                    align: "C"
                });
                ...
                return this.pts(t, n, r), c = !0, this.ptl()
            }, this.ptsli = function(t, n, r) {
                return c || this.ptsl(t, n, r), this
            }, this.ptqc = function(t, n) {
                return t || (t = ""), n || (n = 5), n = Math.min(Math.max(1, n), 16), t.length > 124 && (t = t.substr(0, 124)), this.cmd("QC_SIZE", n), this.cmd("QC_LEN", t.length), this.pt(t), this.cmd("QC_PRINT"), this
            }, this.cut = function() {
                this.cmd("CUT")
            }
        }
        ...
        function _getUdVpids() {
            return _udVpids || (_udVpids = {}, $(_pt.getUserDefineUsbPrinterFlags()).each(function() {
        ...
        function _isUsbPrinter(t, n) {
            var r = _flagToKey(n),
                e = _getUdVpids(),
                i = e[r];
            return i && (String.empty(i.service) || i.service.toLowerCase() == t) ? (!_allProps[r] && (_allProps[r] = {}), !String.empty(i.name) && (_allProps[r].name = i.name), !0) : _self.containts(n) && t && t.indexOf("libusb") >= 0 || "usbprint" == t
        }
        ...
        function _refresh() {
            ...
            n && n.success && $(n.devices).each(function(n, r) {
                ...
                if (i.toString = function() {
                    ...
                    var s, a = _all ? _all[r.key] : null,
                        o = r.init;
                    a || (a = new _WmPrinterWrapper(r), r.init = function() {
                        var t = o ? o.call(r, _self.getCmd(i, "INIT"), 2e3) : r.cmd("INIT");
                        return t && t.success && r.cmd("ENCODING", "chs"), t
                    }, r.set = function(t) {
                        s = t
                    }, r.cmd = function(t, n) {
                        ...
                        t = t || 4;
                        for (var n = 0, r = Math.max(0, t - 3); t > n; n++) n == r ? a.ptsl("  .      ") : a.ptl();
                        a.cmd("CUT")
                    }), t[a.key()] = a
                }
            });
            ...
            r && r.success && $(r.printers).each(function(n, r) {
                ...
                i || (i = new _WmPrinterWrapper(r), r.prop = function(t) {
                    switch (t) {
                        case "name":
                            return r.name || "";
                        case "width":
                    ...
                    return void 0
                }, r.infos.name || (r.infos.name = this.name), r.flag = function() {
                    return null
                }, r.pageEnd = function() {
                    i.cmd("CUT")
                }), t[i.key()] = i
        ...
        function _allPrinters(t) {
            return (!_all || t) && _refresh(), _all
        }

        function _first(t, n) {
            var r;
            return $(t).each(function(t, e) {
                return n.call(e, t, e) ? (r = e, !1) : void 0
            }), r
        }
        ...
        var _all = null,
            _self = this,
            _udVpids;
        this.refresh = _refresh, this.getDefaultPrinter = function(t) {
            return _findDefaultPinter(this.allPrinters(t))
        }, this.getPrinters = function(t, n) {
            var r = this.settings,
                e = r.getSettings(t, !0);
            !e.useModel && "-1" != t && (e = r.getSettings("-1", !0), t = "-1");
            var i = [],
                s = this.allPrinters(n);
            if (n && _refresh(), 0 == e.model) {
                var a = _findDefaultPinter(s);
                a && i.push(a)
            } else $(s).each(function(n, e) {
            ...
            for (var e in n) {
                var i = n[e];
                if (i.test()) {
                    if (_self.containts(i.flag())) return i;
                    r || (r = i)
                }
            }
            return r
            ...
            var n = [],
                r = _allPrinters(t);
            for (var e in r) n.push(r[e]);
            return n
        }, this.allCmdModels = function() {
            var t = [];
            for (var n in _allProps) {
                var r = _allProps[n];
                r.title && (r.name = n, t.push(r))
            }
            return t
            ...
            function e(t) {
                ...
                n("orderCount", 1), n("orderInterval", 1), n("inshopCount", 1), n("inshopInterval", 1), n("inshopAutoPrint", !0), n("pageWidth", 0), n("cmdModel", "default"), n("orderType", "default")
            }
            ...
            this.allSettings = function() {
                ...
                if (e) {
                    var i = e.list[n];
                    return !i && r && (e.list[n] = i = this.newDefPrintSetting(n)), i
                }
                return null
            }, this.save = function() {
                if (s) {
        ...
        if (this.containts = function(t) {
                ...
                if (s = "function" == typeof s ? s(r) : s, !String.empty(s)) {
                ...
                if (!t) return void alert("当前尚未连接打印机");
                if (!t.open()) return void alert("打印机连接失败");
                try {
                    t.init(), t.ptl("美团打印机测试页", "DHW"), t.close()
                } catch (n) {
                    alert(n)
                }
...
define('module/printer', ["util/code", "module/printer_33"], function(t, n) {
    function e() {
        function t(t, n) {
            ...
            return $(t).each(function(t, r) {
                return n.call(r, t, r) ? (e = r, !1) : void 0
            }), e
        }
        ...
        this.refresh = function() {}, this.getDefaultPrinter = function(t) {
            return n(this.allPrinters())
        }, this.getPrinters = function(t, e) {
            var r = this.settings,
                i = r.getSettings(t, !0);
            !i.useModel && "-1" != t && (i = r.getSettings("-1", !0), t = "-1");
            var o = [],
                s = this.allPrinters();
            if (0 == i.model) {
                var u = n(s);
        ...
        }, this.settings = new s, this.charWidthOfPageWidth = function(t) {
            t = parseInt(t);
            var n = 58 / 32;
            return parseInt(t / n)
        }
    ...
    var r = window.wmPrinterApi,
        i = window.wmSystemApi,
        o = (window.wmNetworkApi, i && i.getAppInfo && i.getAppInfo());
    if (o && o.code < 4e3) return n;
    var s = function() {
        function t() {
            this._settings = null, this._settingsKey = "printer_settings"
        }
        ...
        return t.prototype.jsonParse = function(t) {
            ...
            if (!this._settings) {
                ...
                }, e.setStorage(this._settingsKey, JSON.stringify(n))), void 0 == n[-1] && (n[-1] = this.createSettingPoi()), this._settings = n
            }
            ...
            var e = this._getSettings(),
                r = e[t];
            return void 0 == r && n && (r = this.clone(e[-1]), e[t] = r), r
        }, t.prototype.newDefPrintSetting = function(t) {
            var n = {
                id: t,
                enable: !1
            };
            return this._setPrintDef(n), n
        }, t.prototype.getPrinterSetting = function(t, n, e) {
            var r = this.getSettings(t, e);
            if (r) {
                var i = r.list[n];
                return !i && e && (i = this.newDefPrintSetting(n), r.list[n] = i), i
            }
            return null
    ...
    return String.prototype.width = function() {
        ...
        var n = this,
            e = n && n.indexOf("?") < 0 ? "?" : "&";
        for (var r in t) t[r] && (n += e + r + "=" + t[r], e = "&");
        return n
    }, String.format = function(t) {
        var n = Array.clone([].slice.call(arguments)),
            e = n[n.length - 1],
            r = e instanceof Function ? (n.length--, e) : function() {},
            i = t.replace(/\{(\d+)(?::(-)?([^1-9])?(\d+))?\}/gim, function(t, e, i, o, s) {
                function u(t, n) {
                    return void 0 === t || null === t ? n : t
                }
                var a = u(n[e = parseInt(e) + 1], "").toString();
                return s && (a = a.fill(parseInt((i || "") + s), o ? o : " ")), r(e, s), a
            });
        return i
    }, String.empty = function(t) {
        return null === t || void 0 === t || "string" == typeof t && 0 == t.length
    }, Array.clone = function(t) {
        for (var n = [], e = 0, r = t.length; r > e; e++) n.push(t[e]);
        return n
    }, Array.join = function(t, n, e) {
        var r = "";
        for (var i in t) {
            var o = t[i];
            e && !String.empty(o) && (r.length && (r += n), r += o)
        }
        return r
    }, new e
});
...
define('module/order/printorder_parser', ["lib/mustache.min", "module/printer", "util/utils"], function(e, t, r) {
    var n = function(e, t) {
            for (var r = [], t = Math.floor(t); t-- > 0;) r.push(e);
            return r.join("")
        },
        a = function(e) {
            return e % 2 === 1 ? !0 : !1
        ...
        i = function(e) {
            for (var t = len = e.length, r = 0; r < len; r++) e.charCodeAt(r) >= 255 && t++;
            return t
        },
        o = function(e, t) {
            for (var r = 0, n = e.length, a = 0; n > a && (r += e.charCodeAt(a) >= 255 ? 2 : 1, !(r > t)); a++);
        ...
        l = {
            ...
            _getXmlDoc: function(e) {
                ...
                return window.DOMParser ? (t = new DOMParser, r = t.parseFromString(n, "text/xml")) : (r = new ActiveXObject("Microsoft.XMLDOM"), r.async = "false", r.loadXML(n)), r
            },
            ...
            _printNode: function(e, t, r) {
                switch (e.nodeName) {
                    ...
                    case "div":
                        ...
                        if (s ? l.push(this._alignStyle[s]) : "", d ? l.push(this._fontStyle[d]) : "", !this._ifLeafNode(e)) {
                            for (var u = e.childNodes, f = u.length, c = [], h = 0; f > h; h++)("span" === u[h].nodeName && u[h].childNodes.length > 0 || "#text" === u[h].nodeName && "" !== $.trim(u[h].nodeValue)) && c.push(u[h]);
                            f = c.length;
                            for (var h = 0; f > h; h++)
                    ...
                    case "tr":
                        for (var d = e.getAttribute("font"), d = d ? this._fontStyle[d] : "", N = [], u = e.childNodes, f = u.length, h = 0; f > h; h++)
                            ...
                            for (var h = 0; A > h; h++) {
                                ...
                                h === A - 1 ? t.ptl(P, d) : t.pt(P, d), N[h].value = S[1]
                            }
            ...
            printXml: function(e, t, r) {
                for (var n = this._getXmlDoc(e), a = n.getElementsByTagName("print")[0], i = a.childNodes, o = i.length, l = 0; o > l; l++) this._printNode(i[l], t, r)
            }
        },
        s = function(e) {
            return {
        ...
        d = function(t, n) {
            var a = JSON.parse(localStorage.getItem("poiPrintTemplates")),
                i = 0;
            if (a)
                for (var o = 0, l = a.length; l > o; o++) a[o].wmPoiId === n && (i = a[o].nowTemplateId);
            var s = parent.PRINTTEMPLATES[i];
            if (!s) return "";
            s = s.replace(/(&nbsp;|nbsp;)/g, CommConstants.IS_NEW_APP ? " " : "/blank");
            for (var d, u, f = function(e, t, n, a, i) {
                    if ($.isPlainObject(n)) {
                        "mul" === i ? void 0 === n[e] || void 0 === n[t] || isNaN(n[e]) || isNaN(n[t]) || (n[a] = r.multiply(n[e], n[t])) : "equal" === i && void 0 !== n[e] && (d = n[e] + "" === t ? !0 : !1, n[a] = d);
                        for (var o in n) f(e, t, n[o], a, i)
                    } else if ($.isArray(n))
                        for (var l = 0, s = n.length; s > l; l++) f(e, t, n[l], a, i)
                }, c = /#DEF (([^\s]+)#equal#([^\s]+))/g; u = c.exec(s);) f(u[2], u[3], t, u[1], "equal");
            for (var h = /#DEF (([^\s]+)#mul#([^\s]+))/g; u = h.exec(s);) f(u[2], u[3], t, u[1], "mul");
            ...
            submit: function() {
                if ("/v2/order/history/r/print/info/v2" === this.url) {
                    ...
                    $.get("/v2/common/captcha/verify", {
                        ...
                        0 === a.code ? ($("#verifyModal").modal("hide"), e.verifyValue = "") : i.showTip("验证码输入错误，请重新输入")
                    })
                } else $.get("/v2/common/captcha/verify", {
                    verifyValue: this.verifyValue,
                    url: this.url
                }, function(e) {
    ...
    return {
        isPre: function(e, o) {
            ...
            $.get(t.common.getServerTime, function(t) {
                return 0 == t.code && t.unixTime ? a.getTime("yyyy-MM-dd", t.unixTime) != r ? (a.showTip("该订单期望送达日期为[" + r + "]，请勿今日配送！"), o && o.enable(), !0) : !1 : void 0
            })
        },
        getCommentContext: function() {
            ...
            $.ajax({
                ...
                success: function(t) {
                    var s = t.context,
                        r = t.url;
                    s && (o.text(s), a.show(), r && (e.show(), a.addClass("page-jump cursor"), a.attr("data-url", r)))
                }
            })
        },
        commentCompare: o,
        commentStars: function(t) {
            for (var a = "", e = '<span><i class="fa fa-star star bg-yellow"></i></span> ', o = '<span><i class="fa fa-star star"></i></span> ', s = 0; 5 > s; s++) a += s < Math.round(t.toFixed(1)) ? e : o;
            return a
        },
...
define('module/order/printorder_33', ["module/printer", "module/cookie", "util/utils", "module/interface", "module/order/printorder_parser", "widgets/normal_dialog", "components/img_verify", "module/order/order_utils"], function(t, i, e, n, r, o, a, d) {
    ...
    function u(t, i) {
        c("[ajax post] " + t), $.ajax({
            ...
            url: t,
            success: function(t) {
                c("[ajax response] " + JSON.stringify(t)), i({
                    httpSuccess: !0,
                    data: t
                })
            },
            error: function(t, e, n) {
                c("[ajax response error] " + JSON.stringify(t), "error"), i({
                    httpSuccess: !1,
                    statusCode: t.status
                })
            }
    ...
    function p(i) {
        function r(t) {
            if (l) t && t(l);
                ...
                u(i, function(i) {
                    if (i.httpSuccess) l = i.data, 0 === l.code ? t(i.data) : 999 === l.code && new Vue({
                        el: "#verify_img",
                        data: {
                        ...
                        var e = "数据下载失败";
                        i.statusCode && (e += "，状态码：" + i.statusCode), t(null, e)
                    }
                })
            }
        }
        ...
        function c(t, i, e, n) {
            if (!m || !s) return void(n && n(!1, "不支持本地指令打印"));
            if (i.open()) {
                var r = !0;
                try {
                    m(i, t, e)
        ...
        t.settings.reload();
        var l, s = i.dataUrl,
            f = (i.cmdUrl, i.callback || function(t, i) {
                !t && i && e.showTip(i)
            }),
            m = i.localPrintFunc,
            g = i.poiIdFunc;
    ...
    function l(i, n, o, a) {
        if (n.data && n.data.length) try {
            ...
            for (var s in n.data) {
                ...
                for (var m in d)
                    for (var g = 0; g < d[m]; g++) {
                        u && h.sleep && h.sleep(1e3 + 1e3 * u), f.receiptHoler = m, f.caution = f.remark, 1 === f.has_been_invoiced && f.invoice_title && f.invoice_taxpayer_id && -1 === f.invoice_title.indexOf("税号") && (f.invoice_title = f.invoice_title + "（税号：" + f.invoice_taxpayer_id + "）"), f.pickType = f.pick_type;
                        var v = r.jsonToXml(f, a);
                        localStorage.setItem("xmlTempStorage", "string" == typeof v ? v : JSON.stringify(v)), i.init(o), r.xmlToPrinter.printXml(v, i, l), i.pageEnd(o.pageSpace)
                    }
            }
        } catch (w) {
            c("[_printOrder] " + w)
    ...
    function s(t, i, e, r) {
        $.post("/api/order/today/history/print"), p({
    ...
    function m(t) {
        var i = $(this),
            ...
            o = (e.data("orderType") || "", e.data("poiId")),
            a = (e.data("cityId"), i.data("clicked"));
        d.isPre(e), 1 != a && s(n, r, o, i)
    }
    ...
    function w() {
        $.post("/api/order/today/statistics/print"), p({
            ...
            localPrintFunc: function(t, i, e) {
                t.init(e), t.ptl(i.poi_name, "DHW,C"), t.ptl(i.date + " 当日汇总（有效）订单", "DH,C"), t.ptsl("*"), t.ptfl("{0:-6}{1:-25}", "订单号", "金额"), t.ptsl();
                var n = 0,
                    r = 0;
                for (var o in i.list) {
                    var a = i.list[o],
                        d = 2 == a.wm_order_pay_type;
                    t.ptfl("{0:-6}{1:5}{2:-20}", a.num, d ? "(!)" : "", a.total), d && (r++, n += a.total)
                }
                t.ptsl("*"), t.ptl("有效订单数 " + i.count + (r ? " (在线支付 " + r + ")" : "")), t.ptl("总金额￥" + i.total + (n ? " (在线支付￥" + n.toFixed(2) + ")" : "")), t.pageEnd(e.pageSpace)
            },
            gdiPrintFunc: function(t, i, e) {
    ...
    function y(t, i, e) {
        _(t, function(n) {
            n.ptl("#" + t + "订单申请退款", "DHW,C"), n.ptl("请于 " + i + " 前处理退款请求，超时未处理系统将自动退款", "DH"), n.ptl("订单号：" + e)
        })
    }
    ...
    function _(n, r) {
        ...
        if (CommConstants.IS_IN_APP) {
            ...
            d.length ? $(d).each(function(t, i) {
                var n = o(i.key());
                i.open() ? (i.init(n), r(i), i.pageEnd(n.pageSpace)) : e.showTip("打印机连接失败")
    ...
    function I(t, i, e) {
        _(t, function(n) {
            n.ptl("#" + t + "订单已取消", "DHW,C"), n.ptl("请勿继续备餐配送", "DH"), n.ptl("订单号：" + i), n.ptl("取消原因：" + e)
        })
    }

    function P(t, i, e) {
        _(t, function(n) {
            n.ptl(i, "DHW,C"), n.ptl(e, "DH"), n.ptl("订单号：" + t)
        })
    }
    var h = (window.wmNetworkApi, window.wmSystemApi),
...
define('module/order/printorder', ["module/printer", "module/cookie", "util/utils", "module/interface", "module/order/printorder_parser", "widgets/normal_dialog", "components/img_verify", "module/order/order_utils", "module/order/printorder_33"], function(t, i, n, r, e, o, d, a, c) {
    ...
    function l(t, i) {
        u("[ajax post] " + t), $.ajax({
            ...
            url: t,
            success: function(t) {
                u("[ajax response] " + JSON.stringify(t)), i({
                    httpSuccess: !0,
                    data: t
                })
            },
            error: function(t, n, r) {
                u("[ajax response error] " + JSON.stringify(t), "error"), i({
                    httpSuccess: !1,
                    statusCode: t.status
                })
            }
    ...
    function p(i) {
        function e(t) {
            if (p) t && t(p);
                ...
                l(i, function(i) {
                    if (i.httpSuccess) p = i.data, 0 === p.code ? t(i.data) : 999 === p.code && new Vue({
                        el: "#verify_img",
                        data: {
                        ...
                        var n = "数据下载失败";
                        i.statusCode && (n += "，状态码：" + i.statusCode), t(null, n)
                    }
                })
            }
        }
        ...
        function c(t, i, n, r) {
            if (!v || !s) return void(r && r(!1, "不支持本地指令打印"));
            var e = !0;
            try {
                v(i, t, n)
            } catch (o) {
    ...
    function s(i, r, o, d) {
        if (r.data && r.data.length) try {
            ...
            for (var s in r.data) {
                ...
                for (var v in a)
                    for (var g = 0; g < a[v]; g++) {
                        c && C.sleep && C.sleep(1e3 + 1e3 * c), f.receiptHoler = v, f.caution = f.remark, 1 === f.has_been_invoiced && f.invoice_title && f.invoice_taxpayer_id && -1 === f.invoice_title.indexOf("税号") && (f.invoice_title = f.invoice_title + "（税号：" + f.invoice_taxpayer_id + "）"), f.pickType = f.pick_type;
                        var m = e.jsonToXml(f, d);
                        localStorage.setItem("xmlTempStorage", "string" == typeof m ? m : JSON.stringify(m)), W.print(i.id, m, {
                            charWidth: p
                        })
                    }
            }
    ...
    function g(t) {
        var i = $(this),
            ...
            d = (r.data("orderType") || "", r.data("poiId")),
            c = (r.data("cityId"), i.data("clicked"));
        if (a.isPre(r), 1 != c) {
            f(e, o, d, i);
            var u = n.url2Cid();
    ...
    var C = (window.wmNetworkApi, window.wmSystemApi),
        W = window.wmPrinterApi,
        O = C && C.getAppInfo && C.getAppInfo();
    if (!O || O.code < 4e3) return c;
...
define('widgets/exception_prompt', ["widgets/normal_dialog"], function(t) {
    ...
    var o = function(t) {
        ...
        if (this.mainTitle = t.mainTitle, this.subTile = t.subTile, t.target && (this.target = t.target), t.isDialog) this.isDialog = !0, this.html = '<h3 style="margin:0 0 10px 0;text-align:center;font-size:18px;color:#666;">' + t.mainTitle + '</h3><div style="color:#999;">' + t.subTile + "</div>";
        else {
            this.isDialog = !1;
            var e = t.type,
                i = "";
            i = 2 === e ? "no-wifi-icon fa fa-wifi" : "no-data-icon fa fa-file-text-o", this.html = '<div id="exception-pro" class="panel" style="width:500px;margin:0 auto;padding: 50px 0;text-align:center;"><i class="' + i + '"></i><h3 style="margin:20px 0 10px 0;font-size:18px;color:#666;">' + t.mainTitle + '</h3><div style="color:#999;"><span style="display:inline-block;text-align:left;">' + t.subTile + "</span></div></div>"
        }
    };
    ...
    var r = "set_info",
        ...
        t = function() {
            ...
            var u = o.getCookie("wmPoiId"),
                g = String(e.wmPoiId);
            return u !== g ? (console.warn("SET化参数门店ID不匹配"), null) : e.ignoreSetRouterProxy === !0 ? {
                ignoreSetRouterProxy: !0
            } : i(e.region_id) ? null : {
...
define('module/ajax_util', ["module/interface", "module/set", "util/utils"], function(e, r, n) {
    ...
    var s = function(r) {
        ...
        c = function(e) {
            var r = [];
            for (var n in e) r.push(n + "=" + e[n]);
            return r.join("&")
        },
        f = function(e, r) {
            for (var n = 0, t = e.length; t > n; n++)
                if (r && -1 !== r.indexOf(e[n])) return !0
        },
        p = function(e) {
            if (e) {
                for (var r = "", n = 0, t = e.length; t > n; n++) r += String.fromCharCode(2 ^ e.charCodeAt(n));
                return r
            }
            return ""
        },
    ...
    $.ajax = function(e, o) {
        "string" == typeof e && (e = $.extend({
            url: e
        }, o)), e.type && "post" === e.type.toLowerCase() && (e.data && "function" == typeof e.data.append ? e.data.append("csrfToken", i) : e.data = $.extend(e.data || {}, {
            csrfToken: i
        ...
        if (a) {
            ...
            if ((null != p.region_id || null != p.region_version || null != p.ignoreSetRouterProxy) && console.warn("region_id、region_version与ignoreSetRouterProxy为SET化保留参数，请勿设置"), "GET" === d) e.data = $.extend(e.data, a);
            else {
                var g = e.url,
                    x = g.indexOf("?"); - 1 === x ? g += "?" : x !== g.length - 1 && (g += "&");
                var h = [];
                for (var y in a) h.push(y + "=" + a[y]);
                g += h.join("&"), e.url = g
            }
        }
        var O = function(e, r, n) {};
        e.success && jQuery.isFunction(e.success) && (O = e.success), e.success = function(r, n, t) {
            4001 === r.code || 4002 === r.code || 1017 === r.code || O(r, n, t), Owl && Owl.addApi({
                name: e.url,
                statusCode: r.code
            })
        };
        var m = function(e, r, n) {};
        "function" == typeof e.error && (m = e.error), e.error = function(e, r, n) {
            m(e, r, n)
        };
        var _ = s(e.url);
        if (_) {
            ...
            Rohr_Opt.reload(l + e.url + (P ? (e.url.indexOf("?") > -1 ? "&" : "?") + P : "")), e.data ? e.data._token = rohrdata : e.data = {
                _token: rohrdata
            }
        }
        return t(e)
...
define("module/root/new_order/checkOnline", ["widgets/normal_dialog"], function(e) {
    return {
        init: function() {
            this.errorTimes = 0, this.offlineStartTime = 0, this.offlineEndTime = 0, this.isOnline = !0
        },
        ...
        connectedHandler: function() {
            this.offlineTipDialog && this.offlineTipDialog.modal("hide"), this.errorTimes = 0, this.endInterval(), this.isOnline = !0, this.offlineEndTime = Math.floor((new Date).getTime() / 1e3), $.post("/poi/offline/log", {
                fromTime: this.offlineStartTime,
                toTime: this.offlineEndTime
            }, function() {}), console.log("fromTime:" + this.offlineStartTime + ",toTime:" + this.offlineEndTime)
        },
        disconnectedHandler: function(o) {
            var t = this;
            this.errorTimes += 1, 2 == this.errorTimes && (this.checkService("www.baidu.com", function() {
                t.checkLabHouses()
            }, function() {
            ...
            }), this.startInterval(o), this.isOnline = !1, this.offlineStartTime = Math.floor((new Date).getTime() / 1e3)), 1 == this.errorTimes && o.check()
        },
        checkService: function(e, o, t, n) {
            var i = document.createElement("img");
            i.style.display = "none", i.src = "//" + e + "/favicon.ico?" + String(Math.random()), i.onload = function() {
                "function" == typeof o && o(), $(i).remove(), "function" == typeof n && n()
            }, i.onerror = function() {
                "function" == typeof t && t(), $(i).remove(), "function" == typeof n && n()
            }, $("body").append(i)
        },
                        ...
                        btns: [{
                            ...
                            fn: function() {
                                o.checkService("waimaie.meituan.com", function() {
                                    ...
                                    o.offlineTipDialog.modal("hide"), o.checkLabHouses()
                                })
                            }
                        }]
                    }))
    ...
    var s = e.getCookie("acctId"),
        ...
        h = i.getStorage(l) || "",
        m = window.frames[0];
    "" === u && i.getStorage("labelInfo") && (u = i.getStorage("labelInfo"), i.removeStorage("labelInfo"));
    ...
    return {
        ...
        checkLiansuo: function() {
            var e = this,
                o = this._getInnerDoc();
            if (o) var t = o.find("#newOrderNum"),
                i = o.find("#urgencyOrderNum");
            $.get(n.order.getNewAcquiringOrderCount, {}, function(o) {
                var n, r = 0;
                1 == o.code ? (n = o.newOrderNum, r = o.urgencyOrderNum) : (n = 0, r = 0), parseInt(n) > 0 ? (g.audioPlay(), e._showWindow()) : g.audioStop(), e._isInUnprocessedPage() && (t.text(n), i.text(r)), e.updateCount(n)
            })
        },
        check: function() {
        ...
        getCount: function() {
            ...
            $.get(n.order.getNewOrderCount, e._getAccountInfo(), function(t) {
                if (0 == o.isOnline && o.connectedHandler(), t && 0 == t.code) {
                    var t = t.data,
                        n = t.count;
                    e.updateCount(n), t.countLabelInfo && t.countLabelInfo !== h && (i.setStorage(l, t.countLabelInfo), h = t.countLabelInfo)
                } else t && t.msg;
            ...
            $.ajax({
                ...
                success: function(t) {
                    if (0 == o.isOnline && o.connectedHandler(), t && 0 == t.code) {
                        ...
                        r > 0 && e.recordReceiptInfo(a, !1, 0), t.labelInfo && t.labelInfo !== u && (i.setStorage(f, t.labelInfo), u = t.labelInfo), e.checkAndConfirmAutoOrders(n)
                    } else t && t.msg;
        ...
        getListFromInterval: function(e) {
            ...
            $.ajax({
                ...
                success: function(n) {
                    if (0 == o.isOnline && o.connectedHandler(), n && 0 == n.code) {
                        var d = n.data || n.wmOrderList,
                            c = d.length;
                        a.updateCount(c, a._checkIfAllAutoOrders(d) ? "auto" : "");
                        var s = a._getInnerDoc();
                        s && s.find("#orders-container .order").remove(), n.labelInfo && n.labelInfo !== u && (i.setStorage(f, n.labelInfo), u = n.labelInfo), c > 0 && m.postMessage(JSON.stringify({
                            handlerType: "analyseOrder",
                            orderData: d,
                            fontString: n.fontString
                        }), "*");
                        var l = a.getOrderInfos(d);
                        c > 0 && a.recordReceiptInfo(l, !1, 0), c > 0 ? (a._showWindow(), t && t.hide(), location.href.indexOf("order/receive/unprocessed") > -1 && r.hide()) : 0 == c && (t && t.show(), location.href.indexOf("order/receive/unprocessed") > -1 && r({
                            isDialog: !1,
                            mainTitle: "暂无新订单",
                            subTile: "暂时没有新的订单，稍后再来看看吧!",
                            target: ".J-order-list"
                        }).show()), a.checkAndConfirmAutoOrders(d)
                    } else n && n.msg && s && s.find("#validateWarning").text(n.msg);
        ...
        getListFromPush: function(e, o) {
            if (!(this.linkedPoiIds && this.linkedPoiIds.indexOf(o) < 0)) {
                var t = this,
                    ...
                    d = function() {
                        $.get(n.order.getNewOrderFromPush, {
                            ...
                            if (n && 0 == n.code) {
                                var d = n.data;
                                t.updateCount(a + 1, i.ifAutoAccept(o) ? "auto" : ""), m.postMessage(JSON.stringify({
                                    handlerType: "analyseOrder",
                                    orderData: d,
                                    fontString: n.fontString
                                }), "*");
                                var c = t.getOrderInfos(d);
                                t.recordReceiptInfo(c, !0, 0), t._showWindow();
                                var s = t._getInnerDoc();
                                s && s.find("#J-no-order").hide(), location.href.indexOf("order/receive/unprocessed") > -1 && r.hide(), t.checkAndConfirmAutoOrders(d)
                            } else if (n && n.msg) {
                                var s = t._getInnerDoc();
                                s && s.find("#validateWarning").text(n.msg), t.checkAndConfirmAutoOrders([{
                                    wm_poi_id: o,
                ...
                if (this._isInUnprocessedPage()) {
                    if (this._checkIfSameWithPageOrders(e)) return;
                    d()
                } else {
                    var c = localStorage.getItem("autoAcceptWmPoiList") || "";
                    c.indexOf(o) > -1 ? d() : (t.updateCount(a + 1), t._showWindow())
                }
            }
        },
        timeId: null,
        updateCount: function(e, o) {
            ...
            var a;
            parseInt(e) > 0 ? (a = e > 99 ? "99+" : e, o && "auto" === o ? w.audioPlay() : g.audioPlay(), i && i.hide(), location.href.indexOf("order/receive/unprocessed") > -1 && r.hide()) : (a = "", e = 0, g.audioStop(), w.audioStop(), i && i.show(), location.href.indexOf("order/receive/unprocessed") > -1 && r({
                isDialog: !1,
                mainTitle: "暂无新订单",
                subTile: "暂时没有新的订单，稍后再来看看吧!",
                target: ".J-order-list"
            }).show()), localStorage.setItem("count", e), n.text(a), window.refreshOrderModuleNewTag && window.refreshOrderModuleNewTag()
        },
        _checkIfSameWithPageOrders: function(e) {
            var o = this._getInnerDoc();
            if (o)
                for (var t = o.find(".order"), n = 0; n < t.size(); n++)
                    if (t.eq(n).attr("id") == e) return !0;
            return !1
        },
        ...
        _showWindow: function() {
            ...
            if (e && e.showWindow) {
                ...
                } else "flash" === t && e.flashWindow && e.flashWindow("CAPTION,TIMERNOFG,TRAY", 1e3)
            } else window.orderNotify && window.orderNotify({
                request: "New_order",
                "\ufeffpersistent": !0
            })
        },
        ...
        _checkIfAllAutoOrders: function(e) {
            for (var o = 0, t = e.length; t > o; o++) {
                var n = e[o];
                if (!i.ifAutoAccept(n.wm_poi_id)) return !1
            }
            return !0
        },
        _confirmOrder: function(o, r) {
            var d = this,
                ...
                u = {};
            u.invokeTime = (new Date).getTime(), u.orderId = s, u.poiId = c, u.type = 0, $.post(n.order.confirmNewOrder, {
                wmPoiId: c,
                orderId: s,
                acctId: l,
                appType: "3",
                ...
                if (u.responseTime = (new Date).getTime(), 0 === e.code || 10031 === e.code || 10032 === e.code) {
                    10031 === e.code ? d._showAcceptProtocolModal("美团跑腿") : 10032 === e.code && d._showAcceptProtocolModal("混合"), d._removeOrder(s), t.printWhenConfirm(o, void 0);
                    ...
                    if (3 > n && !r) {
                        ...
                        f.on("hide.bs.modal", function(e) {
                            i.setStorage("readTime", n + 1), i.setStorage("isShowDialog", 0)
                        })
                    }
                } else 9 == e.code || e.data && "undefined" != typeof e.data.status && 9 == e.data.status ? d._removeOrder(s) : i.showTip(e.msg);
                u.domTime = (new Date).getTime(), $.post("/api/log/orderLog", u, function(e) {}), i.graphicPrintAfterOrderConfirm(e, c, s)
            })
        },
    ...
    return {
        ...
        _queryChangeAddressOrderCount: function() {
            ...
            $.ajax({
                ...
                success: function(e) {
                    0 === e.code && (r._renderChangeAddressOrderCount(e.data.modifyCount), r.timer && clearTimeout(r.timer), r.timer = setTimeout(function() {
        ...
        _renderChangeAddressOrderCount: function(e) {
            ...
            e > 0 ? r.text(e > 99 ? "99+" : e) : r.empty(), localStorage.setItem("changeAddressOrderCount", e), window.refreshOrderModuleNewTag && window.refreshOrderModuleNewTag()
        },
        init: function() {
    ...
    return {
        ...
        _getRefundOrderCount: function(e) {
            ...
            $.ajax({
                ...
                success: function(n) {
                    0 === n.code && t.handleRefundApply(n.data.toRefundCount), e || setTimeout(function() {
                        t._check()
        ...
        _check: function() {
            this._isInUnprocessedPage() ? this._getRefundOrderList() : (this._getRefundOrderCount(), this._getAbnormalOrderCount())
        },
        handleRefundApply: function(e) {
            var n, t = window.audioControls.refund,
                o = parseInt(localStorage.getItem("orderRefundCount")) || 0,
                r = $(".J-refund-count");
            if ("+1" === e ? n = o + 1 : (n = isNaN(parseInt(e)) ? 0 : parseInt(e), n = n > 0 ? n : -1 === n && o > 0 ? o - 1 : 0), "undefined" != typeof n && n > 0) {
                var d = "";
                d = n > 99 ? "99+" : n, r.text(d), t.audioPlay()
            } else r.empty(), t.audioStop();
            this.innerIframeWindow.postMessage(JSON.stringify({
                handlerType: "updateRefundCount",
                count: n
            }), "*"), localStorage.setItem("orderRefundCount", n), window.refreshOrderModuleNewTag && window.refreshOrderModuleNewTag()
        },
        handlePush: function() {
...
define("module/root/order_reminder_push", ["module/cookie", "module/interface"], function(e, o) {
    ...
    return {
        updateCount: function(e) {
            ...
            0 == e ? (o.removeClass("in"), n && n.audioStop()) : (o.addClass("in"), n && n.audioPlay()), localStorage.setItem("orderReminderCount", e), e > 99 && (e = "99+"), o.text(e), window.refreshOrderModuleNewTag && window.refreshOrderModuleNewTag()
        },
        checkNew: function(e, o) {
            var n = parseInt(localStorage.getItem("orderReminderCount")) + 1;
            this.updateCount(n), location.hash.indexOf("/v2/order/reminder") > -1 && r.location.reload()
        },
...
define("module/root/order_exception_push", ["module/cookie", "module/interface"], function(e, o) {
    ...
    return {
        updateCount: function(e, o) {
            ...
            0 >= e ? (localStorage.setItem("orderExceptionCount", 0), t.empty(), r && r.audioStop()) : (localStorage.setItem("orderExceptionCount", e), e > 99 && (e = "99+"), t.text(e), o && r && r.audioPlay()), window.refreshOrderModuleNewTag && window.refreshOrderModuleNewTag()
        },
        checkNew: function(e, o) {
            var r = parseInt(localStorage.getItem("orderExceptionCount"));
            0 == e ? (r++, this.updateCount(r, !0)) : (r--, this.updateCount(r, !1)), location.hash.indexOf("/v2/order/deliveryException") > -1 && t.location.reload(), location.hash.indexOf("/v2/order/history") > -1 && o && t.location.reload()
        },
        getUnprocessedCount: function() {
            var e = this;
            $.ajax({
...
define('module/root/left_nav', ["module/cookie", "module/root/audio", "module/root/audio_for_old", "module/root/crash_log_reporter", "module/root/new_order", "module/root/change_address_order_count", "module/root/refund_order", "module/root/order_reminder_push", "module/root/order_exception_push", "module/page_jump", "util/utils", "module/root/url_mapping"], function(a, e, n, t, s, C, L, i, d, r, l, c) {
    ...
    function o(a) {
        ...
        a.forEach(function(a, e) {
            ...
            var n = a.subMenus || [];
            t += '<li class="openable">', t += '<a class="nav-header collapsed" href="#menu#' + e + '" data-toggle="collapse" data-menu-code="' + a.menuCode + '" data-label="' + a.menuName + '" ', "门店推广" === a.menuName && (t += 'data-ubl-type="ad" '), t += a.url && 0 === n.length ? 'data-link="' + a.url + '" ' : 'data-expand="true" ', t += ">", t += a.menuIcon ? '<i class="' + a.menuIcon + ' svg-icon font-16"></i>' : g(a.menuName), "订单管理" === a.menuName ? (t += '<span class="text">' + a.menuName, t += '<span class="badge badge-danger J-order-new"></span></span>') : "店铺装修" === a.menuName ? t += '<span class="text J-mark-tip">' + a.menuName : (t += '<span class="text J-mark-tip">' + a.menuName, a.url && 0 === n.length && ("hot" === a.mask ? t += '<span class="badge-new-hot font-12">热</span>' : "new" === a.mask ? t += '<span class="badge-new-hot font-12">新</span>' : "beta" === a.mask ? t += '<span class="badge-new-hot font-12">beta</span>' : "开门营业" === a.menuName && (t += '<span class="wait-open font-12">待开门</span>')), t += "</span>"), t += "</a>", n.length && (t += '<ul id="menu#' + e + '" class="nav nav-list submenu collapse">', n.forEach(function(a, e) {
                t += '<li data-menu-name ="' + a.subMenuName + '" data-menu-code ="' + a.menuCode + '">', t += '<a href="javascript:;" data-link="' + a.url + '" ', "黄金排名" === a.subMenuName && (t += 'data-ubl-type="ad"'), t += ">", t += '<span class="submenu-label" data-label="' + a.subMenuName + '">' + a.subMenuName, "退单" === a.subMenuName ? t += '<span class="badge badge-danger J-refund-count"></span>' : "修改地址" === a.subMenuName ? t += '<span class="badge badge-danger J-change-address-count"></span>' : "催单" === a.subMenuName ? t += '<span class="badge badge-danger J-reminder-count fade"></span>' : "接单" === a.subMenuName ? t += '<span class="badge badge-danger J-order-count"></span>' : "配送异常" === a.subMenuName ? t += '<span class="badge badge-danger J-exception-count"></span>' : "订单定责" === a.subMenuName ? t += '<span class="badge badge-danger J-responsibility-count"></span>' : "订单下载" === a.subMenuName ? t += '<span class="badge badge-danger J-abnormal-count"></span>' : "hot" === a.mask ? t += '<span class="badge-new-hot font-12">热</span>' : "new" === a.mask ? t += '<span class="badge-new-hot font-12">新</span>' : "beta" === a.mask && (t += '<span class="badge-new-hot font-12">beta</span>'), t += "</span>", t += "</a>", t += "</li>"
            }), t += "</ul>"), t += "</li>"
        }), e.html(t), $("a[data-expand]").on("click", function() {
            $(this).toggleClass("collapsed"), $(this).next().toggleClass("in")
        }), p()
    }
    ...
    function g(a) {
        ...
        switch (a) {
            ...
            case "点金推广":
                ...
                break;
            case "服务体验":
                e = '<svg class="svg-icon">\n                <g id="merchantScore">\n                <rect id="Rectangle-3" x="0" y="0" width="16" height="16" fill="#FFF"></rect>\n                <path d="M1.39124279,2.39124279 C2.94037567,0.842109907 5.29331458,0.586683291 7.10751633,1.62496294 L3.51256313,5.21966991 C3.31730099,5.41493206 3.31730099,5.73151455 3.51256313,5.9267767 C3.69280511,6.10701868 3.97642064,6.12088344 4.17256625,5.968371 L4.21966991,5.9267767 L7.92764626,2.21925275 L7.93249391,2.22362901 C9.7960634,0.538044926 12.6753916,0.593916186 14.4727182,2.39124279 C16.2683803,4.18690487 16.3258111,7.06256541 14.6450106,8.92731084 L14.6494949,8.93198052 L8.99264069,14.5888348 C8.40685425,15.1746212 7.45710678,15.1746212 6.87132034,14.5888348 L1.21446609,8.93198052 L1.21895038,8.92731084 C-0.461850095,7.06256541 -0.404419292,4.18690487 1.39124279,2.39124279 Z"></path>\n                </g>\n                </svg>';
                break;
            case "经营指导":
            ...
            case "开放平台":
                ...
                break;
            case "团好药服务":
                e = '<svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16px" height="16px" viewBox="0 0 16 16" version="1.1"><path d="M14.25,0.5 C14.9403559,0.5 15.5,1.05964406 15.5,1.75 L15.5,8.5 C15.5,12.3659932 12.3659932,15.5 8.5,15.5 L1.75,15.5 C1.05964406,15.5 0.5,14.9403559 0.5,14.25 L0.5,7.5 C0.5,3.63400675 3.63400675,0.5 7.5,0.5 L14.25,0.5 Z M8.12487861,5 L5.1875,5 C4.53166186,5 4,5.53166186 4,6.1875 C4,6.84333814 4.53166186,7.375 5.1875,7.375 L5.1875,7.375 L6.93987861,7.375 L3.0446893,11.2717086 C2.58094171,11.7354562 2.58094171,12.4873396 3.0446893,12.9510872 C3.5084369,13.4148348 4.26032031,13.4148348 4.72406791,12.9510872 L4.72406791,12.9510872 L8.62487861,9.05 L8.625,10.8125 C8.625,11.4683381 9.15666186,12 9.8125,12 C10.4683381,12 11,11.4683381 11,10.8125 L11,10.8125 L10.9998786,7.939 L9.8125,7.94 L9.65843326,7.93306128 C8.84658112,7.85958276 8.20067465,7.21110356 8.13119413,6.39810396 L8.13119413,6.39810396 L8.125,6.2525 L8.12487861,5 Z M9.8125,2.8125 C9.15666186,2.8125 8.625,3.34416186 8.625,4 L8.625,4 L8.625,6.2525 C8.625,6.90833814 9.15666186,7.44 9.8125,7.44 L9.8125,7.44 L12.0625,7.44 C12.7183381,7.44 13.25,6.90833814 13.25,6.2525 C13.25,5.59666186 12.7183381,5.065 12.0625,5.065 L12.0625,5.065 L11,5.0645 L11,4 C11,3.34416186 10.4683381,2.8125 9.8125,2.8125 Z" id="形状结合" fill="#3F4156"/></svg>'
        }
        return e
    }
    ...
    function h() {
        var a = $(".J-model-menu");
        a.removeClass("hide"), p()
    }

    function p() {
        CommConstants.IS_IN_APP && s.init(), C.init(), L.init(), i.getUnprocessedCount(), d.getUnprocessedCount(), $("#wrapper").layout({
            sidebarToggle: !0
        });
        var a = $(".J-main-menu");
        a.find("a[data-link]").click(function() {
            ...
            var a, e, n = $(this),
                t = n.data("label") || n.parent().data("menu-name") || "";
            switch (t) {
                case "配送信息":
                    a = "c_shangou_online_e_6b2yb530", e = {
                        category: "shangou_online_e"
                    };
                case "跑腿配送":
                    a = "c_shangou_online_e_9n3var0g", e = {
                        category: "shangou_online_e"
                    };
                default:
                    a = "c_shangou_online_e_yq5ycuff", e = null
            }
            ...
            var a = $(this),
                e = "",
                n = a.data("label");
            "订单管理" === n ? (e = "订单定责,餐损赔付", $('[data-menu-name="餐损赔付"]').addClass("hide"), $('[data-menu-name="订单定责"]').addClass("hide"), "-1" != u && $.ajax({
            ...
            })) : (e = "订单赔付,出餐时间", $('[data-menu-name="订单赔付"]').addClass("hide"), $('[data-menu-name="出餐时间"]').addClass("hide")), $.ajax({
        ...
        var e = function() {
            function e() {
                $(".nav-list").each(function(a, e) {
                    ...
                    if (n.length > 1) $(e).prev().find(".J-mark-tip").children("span").remove().end().append(' <span class="badge-dot"></span>');
                    else {
                        var t = n.text();
            ...
            function n() {
                a.find("a[data-link]").each(function(a, e) {
                    ...
                    if (s) var C = $.trim(s.firstChild.nodeValue);
                    else var C = $.trim(t.firstChild.nodeValue);
                    n && -1 !== n.indexOf(C) && ($(e).find(".badge-new-hot").remove(), $(e).find(".badge-dot").remove())
                })
            }
            n(), e(), a.find("a[data-link]").click(function() {
                var a = $(this);
                if (a.find(".badge-new-hot").length) {
                    ...
                    n ? -1 === n.indexOf(C) && localStorage.setItem("clickedAll", n + C) : localStorage.setItem("clickedAll", C), a.find(".badge-new-hot").remove(), a.find(".badge-dot").remove()
                }
                e()
            })
        };
        e(), window.refreshOrderModuleNewTag = function() {
            var a = parseInt(localStorage.getItem("count")) || 0,
                ...
                L = a + e + n + s + C + t,
                i = $(".J-order-new");
            L > 0 ? (L > 99 && (L = "99+"), i.text(L).show()) : i.hide()
            ...
            var e = parseInt(localStorage.getItem("orderResponsibilityCount")) || 0,
                ...
                a = parseInt(a),
                t = 0;
            if (a > 0 ? t = a : -1 === a && e > 0 && (t = e - 1), t > 0) {
                var s = "";
                s = t > 99 ? "99+" : t, n.text(s)
            } else n.empty();
            localStorage.setItem("orderResponsibilityCount", t), window.refreshOrderModuleNewTag()
        }, "function" == typeof window.goPager && window.goPager()
    }
    window.NewOrder = s, window.ChangeAddressOrderCount = C, window.RefundOrder = L, window.orderReminderPush = i, window.orderExceptionPush = d;
        ...
        $.ajax({
            ...
            success: function(a) {
                if (0 === a.code) {
                    var e = a.data,
                        n = e.menus || [];
                    n.length ? (o(n), window.initPageMap ? window.initPageMap(n) : window.navMenus = n) : h()
                } else h()
            },
            error: function() {
                h()
    ...
    $(".J-sidebar-toggle").click(function() {
        var a = $(this),
            e = "";
        v.removeClass("pack-up-sidebar-delay"), v.toggleClass("pack-up-sidebar"), e = v.hasClass("pack-up-sidebar") ? "向右展开" : "向左收起", a.find(".text").text(e)
    }), $("#aside").hover(function() {
        v.append('<div class="full-screen-mask"></div>')
    }, function() {
        $(".full-screen-mask").remove(), v.hasClass("pack-up-sidebar") && v.addClass("pack-up-sidebar-delay")
    });
    try {
        t.report()
    } catch (m) {}
...
function Socket(t, n, e) {
    this.urlList = t, this.path = n, this.useLoop = e
}

function WebSocketClient(t, n, e) {
    this.socket = window.socket, (null == this.socket || void 0 == this.socket) && (this.socket = new Socket(t, n, e), window.socket = this.socket, this.socket.connect(), window.socket_env = "online")
}

function keepAlive(t) {
    var n = new Date; - 1 != last_health && n.getTime() - last_health > health_timeout ? t.close() : sendHB(t)
}
...
function getCookie(t) {
    ...
    function n(t) {
        for (var n = e, o = 0; o < t.length; o++) n = n[t[o]] = n[t[o]] || {};
        return n
    }
    var e = {
        version: .1
    ...
    e.apply = function(t, n) {
        if (t && n && "object" == typeof n)
            for (var e in n) "undefined" != typeof n[e] && (t[e] = n[e]);
        return t
    }, e.ns = function(t, o) {
        var i = "string" == typeof t ? n(t.split(".")) : e;
        return e.apply(i, t), o && "function" == typeof o && (o = o.apply(i, [e])), e.apply(i, o)
    }, e.WVS = {}, t.watt = e
}(window), watt.ns("bus", function(t) {
    t.WVS.BUS = {};
    var n = function(n) {
        return this.ns = n || this._DEF_NAMESPACE, this.events = {}, t.WVS.BUS[this.ns] ? t.WVS.BUS[this.ns] : (t.WVS.BUS[this.ns] = this, this)
    };
    n.prototype = {
        ...
        on: function(t, n) {
            ...
            if (n && "function" == typeof n)
                for (; e = o.shift();)(this.events[e] || (this.events[e] = [])).push(n);
            return this
        },
        off: function(t, n) {
            if (t || n) {
                for (var e, o, i = t.split(/\s+/); e = i.shift();)
                    if (o = this.events[e])
                        if (n)
                            for (var s = o.length - 1; s >= 0; s--) o[s] === n && o.splice(s, 1);
        ...
        emit: function(t, n, e) {
            for (var o, i, s, c = t.split(/\s+/); o = c.shift();)
                for (i = (this.events[o] || []).slice(); s = i.shift();) s.apply(e || this, n || []);
            return this
        }
    };
    var e = function(n, e) {
        4 == n.length ? "string" != typeof n[1] && (n[3] = n[2], n[2] = n[1], n[1] = n[0], n[0] = t.bus.Bus._DEF_NAMESPACE) : "function" == typeof n[1] && (n[2] = n[1], n[1] = n[0], n[0] = t.bus.Bus._DEF_NAMESPACE);
        for (var o, i, s = n.shift().split(/\s+/g); o = s.shift();) i = t.WVS.BUS[o || t.bus.Bus._DEF_NAMESPACE], i && i[e].apply(i, n)
    };
    return t.ns({
        on: function(t, n, o) {
            return e([t, n, o], "on"), this
        },
        off: function(t, n, o) {
            return e([t, n, o], "off"), this
        },
        one: function(t, n, o) {
            return e([t, n, o], "one"), this
        },
        emit: function(t, n, o, i) {
            return e([t, n, o, i], "emit"), this
        },
        Bus: function(n) {
            new t.bus.Bus(n)
        }
        ...
        extend: function() {
            ...
            return function(e, o, i) {
                var s, c = function() {
                    ...
                    r = function() {},
                    a = e.prototype;
                return r.prototype = a, s = c.prototype = new r, s.constructor = c, c.superclass = a, a.constructor == n && (a.constructor = e), c.override = function(t) {
                    N.override(c, t)
                }, s.superclass = function() {
                    return a
                }, s.override = t, N.override(c, i), c.extend = function(t) {
                    return N.extend(c, t)
                }, c
            }
        }()
...
N.NetDaemon = {
    ...
    _onOffline: function(t) {
        this._netStatus = this.STATUS_OFFLINE, this.log("Net status change. from " + t + " to STATUS_OFFLINE================"), this._connection && this._connection.stopHeartBeat()
    },
    _onPingSuccess: function(t) {
        this._netStatus = this.STATUS_PING_SUCCESS, this.log("Net status change. from " + t + " to STATUS_PING_SUCCESS================"), watt.emit("pingSuccess")
    },
    _onPingFail: function(t, n) {
        this._netStatus = this.STATUS_PING_FAIL, this.log("Net status change. from " + n + " to  STATUS_PING_FAIL, reconnect " + t / 1e3 + "s later=============="), this.reconnect(t)
    },
    _onEvents: [function(t) {
        ...
        switch (t) {
            case this.EVENT_ONLINE:
                this._netStatus = this.STATUS_ONLINE, this.log("Net status change. from " + n + " to STATUS_ONLINE, reconnecting==================="), watt.emit("online"), this.reconnect(1e4);
                break;
            case this.EVENT_OFFLINE:
                this.log("Net status change. unexpected event. on " + n + ", and comes a EVENT_OFFLINE");
                break;
            case this.EVENT_PING_SUCCESS:
                this.log("Net status change. unexpected event. on " + n + ", and comes a EVENT_PING_SUCCESS"), this._onPingSuccess(n);
                break;
            case this.EVENT_PING_FAIL:
        ...
        switch (t) {
            ...
            case this.EVENT_PING_SUCCESS:
                ...
                break;
            case this.EVENT_PING_FAIL:
                this.log("Net status change. from STATUS_PING_FAIL to " + n + ". reconnect " + this.PING_FAIL_DELAY / 1e3 + "s later.=========="), this.reconnect(this.PING_FAIL_DELAY)
        }
    }],
    log: function(t) {
    ...
    connected: function(t) {
        this._connection = t, this.changeStatus(this.STATUS_PING_SUCCESS)
    },
    ...
    init: function() {
        ...
        isSupportOnline && (window.addEventListener("online", function() {
            ...
            t._connection || (t._connection = N.connection, t.changeStatus(t.STATUS_PING_SUCCESS))
        })
    }
}, N.NetDaemon.init();
var last_health = -1,
    health_timeout = 3e3,
    timeoutStep = -1e4;
window.heartBeatResult = !0, window.heartbeat_timer = 0, window.retryConnect_timer = 0, window.retryConnect_index = 0, window.socket, window.onMsgListeners = [], window.onOpenListeners = [], window.onCloseListeners = [], window.onErrorListeners = [], window.socket_env = "online", Socket.prototype.connect = function() {
    ...
    if (window.WebSocket) try {
        ...
        if (this.connection = new WebSocket(this.urlList[n] + this.path), this.useLoop) {
            var e = this.urlList.length;
            n === e - 1 ? window.retryConnect_index = 0 : window.retryConnect_index = n + 1
        }
    } catch (t) {} else this.connection = {};
    watt.emit("created", [window.socket]), this.connection && (this.connection.onmessage = function(t) {
        if (null == t || null == t.data || "HB" == t.data) return void("HB" == t.data && (window.heartBeatResult = !0, N.NetDaemon.changeStatus(N.NetDaemon.STATUS_PING_SUCCESS)));
        var n = "";
        try {
        ...
        for (var o = 0; o < window.onMsgListeners.length; o++) window.onMsgListeners[o](n)
        ...
        window.heartbeat_timer && clearInterval(window.heartbeat_timer), window.heartBeatResult = !0, window.heartbeat_timer = setInterval(function() {
            keepAlive(n), window.crash_heartbeat && window.crash_heartbeat()
        }, 1e4), window.retryConnect_timer && clearInterval(window.retryConnect_timer);
        for (var e = 0; e < window.onOpenListeners.length; e++) window.onOpenListeners[e](t);
        watt.emit("connected", [window.socket])
    }, this.connection.onerror = function(t) {
        clearInterval(window.heartbeat_timer);
        for (var n = 0; n < window.onErrorListeners.length; n++) window.onErrorListeners[n](t)
    }, this.connection.onclose = function(t) {
        clearInterval(window.heartbeat_timer);
        for (var n = 0; n < window.onCloseListeners.length; n++) window.onCloseListeners[n](t);
    ...
    var n = this;
    timeoutStep += 1e4, t += timeoutStep, window.retryConnect_timer = setInterval(function() {
        retryConnect(n)
    }, t)
...
define('widgets/global_poptip', ["module/cookie", "module/interface", "util/utils"], function(t, s, a) {
    ...
    return {
        init: function() {
            ...
            n = $(s), o = n.find(".J-poptip-body"), n.hide().appendTo($("#J-global-tips"));
            var a = n.find(".J-close");
            a.on("click", t.hide), this.reportData()
        },
        reportData: function() {
            var t = $("#J-global-tips");
            t && (a.reportMV("b_waimai_e_v8b47ocp_mv", "c_waimai_e_um55opap"), t.on("click", function() {
                a.reportMC("b_waimai_e_v8b47ocp_mc", "c_waimai_e_um55opap")
            }))
        },
        setRest: function(s, a, n) {
            var o = this,
                i = (t.getCookie("wmPoiId"), function(t) {
                    var n = "";
                    "系统" === s || "平台" === s ? (n = a, t(n)) : (n = "置休分店从现在起不接收新订单，手动恢复营业后可正常接收新订单", t(n))
                });
            i(function(t) {
                var a = $('<div class="set-rest"><p class="icon"><i class="circle">休</i></p><p class="title">' + ("手动" === s ? n : "") + "已被" + s + '置休</p><p class="content fc-gray">' + t + '</p><p class="opr"><a href="javascript:;" class="btn btn-primary page-jump J-detail" data-url="/v2/shop/manage">查看详情</a><button class="btn btn-default J-ignore">忽略</button></p></div>'),
                    i = $(".global-poptip");
                a.find(".J-ignore").on("click", o.hide), a.find(".J-detail").on("click", o.hide), i.find(".panel-body").html(a).end().show(), o.showBadge()
            })
        },
        ...
        showImTip: function() {
            ...
            var a = $(".global-poptip");
            a.find(".panel-body").html(s).end().show(), t.showBadge()
        },
            ...
            "2" === i ? $.ajax({
                ...
                success: function(s) {
                    if (0 === s.code) {
                        ...
                        c.find(".J-ignore").on("click", e.hide), c.find(".J-detail").on("click", e.hide), o.html(c).end().show(), e.showBadge()
                    }
                }
            }) : setTimeout(function() {
                ...
                s.find(".J-ignore").on("click", e.hide), s.find(".J-detail").on("click", e.hide), o.html(s).end().show(), e.showBadge()
            }, 200)
        },
        showManagerChange: function(t) {
            ...
            a.find(".J-ignore").on("click", s.hide), o.html(a).end().show(), s.showBadge()
        },
        showUpdate: function() {
            var t = this,
            ...
            s.find(".J-ignore").on("click", t.hide), s.find(".J-refresh").on("click", function() {
                location.reload(!0)
            }), o.html(s).end().show(), t.showBadge()
        },
        hide: function() {
            n.hide(), i.removeClass("show")
        },
        showBadge: function() {
            i.addClass("show")
        }
            ...
            $.ajax({
                ...
                success: function(e) {
                    if (0 == e.code) {
                        ...
                        } else $(".boards-wrapper-exception").empty(), $(".J-exception-title").length && $(".J-exception-title").parents(".modal").modal("hide")
                    }
                }
            })
        }
...
define('module/root/push_schedule', ["module/cookie", "util/utils", "module/root/push_client", "module/order/printorder", "widgets/tips_append", "module/interface", "widgets/global_poptip", "module/exception_info", "widgets/normal_dialog", "module/page_jump"], function(e, s, a, o, t, i, n, r, d, c) {
    ...
    if (h > m && (k = !0), !p) {
        ...
        e.setCookieEx("pushToken", y, 31536e3), p = y
    }
    g.push(w), -1 !== _.indexOf("test") ? g.push("ws://1953-nvoyb-sl-wpush.waimai.test.meituan.com") : -1 !== _.indexOf(".st.") ? g.push("wss://wpush.waimai.st.meituan.com") : -1 !== _.indexOf("shangoue") && g.push("wss://bj-wpush.waimai.meituan.com", "wss://sh-wpush.waimai.meituan.com");
    ...
    O.onOpenListener(function() {
        ...
        function l() {
            var e = JSON.parse(localStorage.getItem("modalMessages")); - 1 === e.msg.indexOf(m.title) && e.count < 5 && e.msg.push(m.title), e.count++, localStorage.setItem("modalMessages", JSON.stringify(e))
        }
        var m = JSON.parse(a);
        if (m.handlerType = "fromPushMessage", console.log(m, "监听webSocket数据返回"), m && m.code) switch (parseInt(m.code)) {
            case 1:
            ...
            case 4:
                ...
                switch (parseInt(f)) {
                    case 0:
                    case void 0:
                        if (window.RefundOrder.handlePush(), !v) return void $.post(i.pc.report, {
                            logMsg: a
                        });
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        y.audioPlay(), o.printCancelTips(h, v, "订单超建议送达时间30分钟以外");
                        break;
                    case 3:
                        y.audioPlay(), o.printCancelTips(h, v, "接单1分钟内顾客取消");
                        break;
                    case 4:
                        y.audioPlay(), o.printCancelTips(h, v, "顾客退款请求超时未处理");
                        break;
                    case 5:
                        var I = d({
                            title: "极速退款提醒",
                            ...
                            btns: [{
                                txt: "去关闭",
                                fn: function() {
                                    localStorage.setItem("speedRefundFromPush", "true"), window.location.hash = "/v2/shop/manage/speedRefund?fromPush=true", I.modal("hide")
                                }
                            }, {
                                txt: "继续开通"
                            }]
                        ...
                        break;
                    case 6:
                        y.audioPlay(), o.printCancelTips(h, v, "商家开通极速退款服务，顾客退款系统自动通过");
                        break;
                    case 10:
                        JSON.parse(m.is_refresh_order) && window.RefundOrder.handlePush(), m.audio_type && window.audioControls[m.audio_type] && window.audioControls[m.audio_type].audioPlay(), JSON.parse(m.show_message) && t.assembleNormalTip(m.message), m.print_title && o.printReturnGoodsTips(v, m.print_title, m.print_content || "")
                }
                break;
            case 6:
            ...
            case 12:
                ...
                break;
            case 13:
                n.setRest("系统", m.message.replace(/\+/g, " ")), $.post(i.common.postHearbeatRestLog, {
                    wmPoiId: m.wmPoiId
                });
                break;
            case 14:
            ...
            case 16:
                ...
                break;
            case 17:
                if (b.postMessage(JSON.stringify(m), "*"), "true" === m.cancelOrderSound) {
            ...
            case 21:
                var N = d({
                    ...
                    btns: [{
                        txt: "去看看",
                        fn: function() {
                            window.location.hash = "/v2/newcome/privilegeInfo?flag=4", N.modal("hide")
                        }
                    }, {
                        txt: "知道了",
                        fn: function() {
            ...
            case 25:
                ...
                break;
            case 26:
                if (b.postMessage(JSON.stringify(m), "*"), 1 == m.large_order) {
                ...
                1 == m.recovery && t.assembleNormalTip(m.wm_order_view_id + "号订单，配送恢复正常"), window.orderExceptionPush.checkNew(m.recovery, m.large_order);
                break;
            case 27:
                var T = e.getCookie("device_uuid"),
                    ...
                    M = function() {
                        ...
                        e ? (-1 === t.indexOf(o) && (t = o), -1 === t.indexOf(e) && (window.audioControls["new-message-again"].audioPlay(), s.setStorage("waimai_hasRemindTwoMinutesUserIds", t + "," + e))) : window.audioControls["new-message-again"].audioPlay()
                    };
                x ? x == T && M() : M();
                break;
            case 28:
            ...
            case 999:
                ...
                if (J && (j = J.length <= 1), R && 1 !== R) {
                    ...
                    } else if (3 === R) s.showTip(m.message);
                    else if (4 === R) {
                        if (j) var z = parseInt(m.type),
                            D = m.title,
                            A = m.content,
                ...
                } else t.assembleNormalTip(m.message);
                break;
            case 2e3:
                location.href = "/"
        }
    ...
    var S = function(e) {
        if (b.postMessage(JSON.stringify(e), "*"), 1 === e.operator && 100 === e.logisticsStatus && !$("#delivery-cancelled-dialog").size()) var s = d({
            title: "订单配送被取消",
            ...
            btns: 1 === e.logisticsType ? [{
                ...
                txt: "重发配送",
                fn: function() {
                    c.go("/v2/order/receive/processed"), s.modal("hide")
                }
            }, {
                txt: "稍后处理"
            }],
        ...
        if (2 === e.operator && 100 === e.logisticsStatus) var a = d({
            title: "订单配送被取消",
            content: e.message,
            btns: [{
                txt: "查看订单",
        ...
        d = {
            getSetParams: function() {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    success: function(t) {
                        t = t || {}, 0 === t.code && e.saveParams(t.data)
                    }
                }), setTimeout(function() {
                    t.getSetParams()
                }, 36e5)
            ...
            getPreOrderCount: function() {
                ...
                $.ajax({
                    ...
                    success: function(t) {
                        var e = t.spanCount || 0;
                        i.assemblePreOrderCountTip(t), localStorage.setItem("assemblePreCount", e), r.postMessage(JSON.stringify({
            ...
            reportOperationStatus: function() {
                ...
                m += "&longitude=" + i + "&latitude=" + s + "&ip=" + u, Rohr_Opt && "function" == typeof Rohr_Opt.reload && (r = Rohr_Opt.reload(m)), localStorage.removeItem("logonSuccess"), $.post(d, {
                    wmPoiId: n,
                    acctId: a,
                    uuid: c,
                    type: o,
            ...
            getBusinessStatus: function() {
                ...
                $.ajax({
                    ...
                    success: function(t) {
                        0 == t.code && (t.wmPoiStatusDesc && $("#select_poi_status_button_text").text(t.wmPoiStatusDesc), t.hasSpecialShippingTime && 0 === $(".J-change-status-wrapper .notice").length ? $('<span class="notice"><i></i></span>').insertAfter("#select_poi_status_button_text") : t.hasSpecialShippingTime || $(".J-change-status-wrapper .notice").remove())
                    }
                }), setTimeout(function() {
                    t.getBusinessStatus()
                }, 12e4)
            ...
            init: function() {
                this.getSetParams(), this.reportPcInfo(), this.getAcceptWmPoiList(), this.getPreOrderCount(), this.getFeVersion(), this.updatePushToken(), this.updatePushTokenAndIm(), this.getTimeoutOrderNotice(), this.reportOperationStatus(), "-1" !== n && this.getBusinessStatus()
            }
        };
    d.init()
});
    ...
    var n = localStorage.getItem("printTemplates"),
        ...
        r = function(t) {
            for (var e = i.length, n = 0; e > n; n++)
                if (i[n].wmPoiId === t) return i[n].nowTemplateId;
            return 0
        };
    window.PRINTTEMPLATES = {}, $.ajax({
        ...
        var n = e,
            ...
            i = [];
        if (o > 0) {
            for (var s = 0; o > s; s++) - 1 !== n[s].id && i.push({
                wmPoiId: n[s].id,
                version: 1,
            ...
            $.ajax({
                ...
                success: function(t) {
                    if (0 === t.code) {
                        for (var e = t.data, n = e.length, o = 0; n > o; o++) a[e[o].nowTemplateId] = e[o].templateUrl, i.map(function(t) {
                        ...
                        for (var T in a) i.some(function(t) {
                            return t.nowTemplateId === parseInt(T)
                        }) ? (r = a[T].replace("https:", "").replace("http:", ""), s[T] = 0, m(T)) : delete a[T];
                        localStorage.setItem("printTemplates", JSON.stringify(a)), localStorage.setItem("poiPrintTemplates", JSON.stringify(i))
                    }
                }
            })
        } else localStorage.setItem("printTemplates", JSON.stringify({})), localStorage.setItem("poiPrintTemplates", JSON.stringify([]))
    })
});
! function(t, o) {
    ...
    a.inform = function(t) {
        ...
        var o = -1;
        t && void 0 !== t.step && (o = t.step), window.history.go(o)
    }, a.jumpTo = function(o) {
        var e = o.href || "/index";
        o.nojump && localStorage.setItem("nojump", !0), o.selectLabel && localStorage.setItem("selectLabel", o.selectLabel), t.go(e)
    };
    ...
    $("body").append(n = $(i)), n.find(".btn-primary").click(function(t) {
        var o = n.find("form");
        0 != o.size() && d.postMessage(o.serialize(), l)
    }), a.dialog = function(t) {
        n.find(".modal-title").text(t.title || "提示"), n.find(".modal-body").html(t.content || ""), n.modal("show")
    ...
    var l, d = window.frames[0],
        s = function(t) {
            var o = !1;
            if (t.origin === location.origin && (o = !0), window.frames.hashframe === t.source && (o = !0), window.frames.contractframe === t.source && (o = !0), o) {
                l = t.origin;
                var n, i = t.data;
                try {
                    n = JSON.parse(i)
                } catch (r) {
                    if ("[object Object]" !== e.call(i)) return;
                    n = i
                }
                var d = n.method;
                if (d) {
    ...
    return window.addEventListener("message", s), a.postMessage = function(t) {
    ...
    return {
        init: function(e) {
            ...
            o.onmousedown = function(e) {
                ...
                t = !0, i = e.clientX, u = e.clientY, c = parseInt(o.width), r = parseInt(o.height)
                ...
                if (t) {
                    var o = e.clientX,
                        ...
                        f = c + (i - o),
                        l = r + (u - s);
                    if (550 > f || f > 800) return !1;
                    if (400 > l || l > 700) return !1;
                    n.style.width = f + 10 + "px", n.style.height = l + 10 + "px"
                }
    ...
    return {
        ...
        methods: {
            toggleFoodRecommend: function() {
                this.showFoodRecommendModal = !this.showFoodRecommendModal, t.reportMC("b_shangou_online_e_svy4tldc_mc", "c_shangou_online_e_81ellaw0")
            },
            ...
            checkFoodRecommendCapability: function(o) {
                ...
                $.ajax({
                    ...
                    success: function(o) {
                        0 == o.code && (t.foodRecommendCapability = o.data.productCapability, (2 == t.foodRecommendCapability || 3 == t.foodRecommendCapability) && (t.foodUrl = o.data.productUrl, t.getFoodRecommendInfo()))
                    },
                    error: function(o) {}
                })
            },
            getFoodRecommendInfo: function() {
                ...
                if ("food" == a) o.getWmFoodListAndCategory();
                else {
                    var d = {
                        acctId: o.acctId,
                    ...
                    $.ajax({
                        ...
                        data: d,
                        success: function(e) {
                            o.xhrStatus = 1, 0 === e.code ? (o.foodCategoryList = e.data.tagList || [], o.foodCategoryList.unshift({
                                id: "",
                                name: "全部商品"
            ...
            getWmFoodListAndCategory: function(o, a) {
                ...
                d.xhrStatus = 0, d.searchWord ? ($.extend(s, {
                    name: d.searchWord
                }), $.ajax({
                    ...
                    data: s,
                    success: function(o) {
                        d.xhrStatus = 1, 0 === o.code ? d.foodList = o.data.productList || [] : t.showTip("获取商品信息失败，请稍后重试")
                    }
                })) : $.ajax({
                    ...
                    data: s,
                    success: function(e) {
                        d.xhrStatus = 1, 0 === e.code ? (o || (d.foodCategoryList = e.data.tagList), e.data.productList && (d.foodPageNum > 1 ? d.foodList = d.foodList.concat(e.data.productList) : d.foodList = e.data.productList, a && a())) : t.showTip("获取商品" + (s.needTagList ? "分类" : "") + "信息失败，请稍后重试")
                    }
                })
            },
            getScFoodList: function(o) {
                var a = this,
                    d = (CommConstants.shopCate, e.productManage),
                    s = {
                        token: a.token,
                        acctId: a.acctId,
                ...
                a.searchWord && $.extend(s, {
                    ...
                    data: s,
                    success: function(o) {
                        if (a.xhrStatus = 1, 0 === o.code) {
                            var e = o.data.productList || [];
                            a.foodPageNum > 1 ? a.foodList = a.foodList.concat(e) : a.foodList = e, a.isDropdown = !1
                        } else t.showTip("获取商品信息失败，请稍后重试")
                    }
                })
            },
            setFirstCategory: function(o, t) {
                var e = this;
                e.activeFirstCategory != o && (e.activeFirstCategory = o, e.activeSecondCategory = null, e.foodSecondCategoryList = [], e.activeFirstCategory.subTags && e.activeFirstCategory.subTags.length ? (e.foodSecondCategoryList = e.activeFirstCategory.subTags, e.setSecondCategory(e.activeFirstCategory.subTags[0], !1)) : (e.foodPageNum = 1, "food" == CommConstants.shopCate ? t && e.getWmFoodListAndCategory(o, e.toggleDropdown) : e.getScFoodList(o)))
            },
            setSecondCategory: function(o, t) {
                var e = this;
                e.activeSecondCategory != o && (e.activeSecondCategory = o, e.foodPageNum = 1, "food" == CommConstants.shopCate ? e.getWmFoodListAndCategory(o, t ? e.toggleDropdown : null) : e.getScFoodList(o))
            },
            sendFood: function() {
                var o = this,
                ...
                e.forEach(function(t) {
                    ...
                    return o.checked = !1, o
                }), o.toggleFoodRecommend(), t.reportMC("b_shangou_online_e_48sm6njt_mc", "c_shangou_online_e_81ellaw0")
            },
            handleCheckFood: function(o, e) {
                ...
                a.length > 9 && (t.showTip("单次最多发送9个商品"), o.checked = !1, e.target.checked = !1)
            },
            searchByName: function() {
                var o = this,
                    t = this.$refs.searchInput.value,
                    e = o.activeSecondCategory || o.activeFirstCategory;
                o.searchWord = t, o.foodPageNum = 1, $(".food-list")[0].scrollTop = 0, "food" == CommConstants.shopCate ? o.getWmFoodListAndCategory(e, closeSelect ? o.toggleDropdown : null) : o.getScFoodList(e)
            },
            getMoreFood: function(o) {
                ...
                if (a > e - t - 20 && 1 == this.xhrStatus) {
                    ...
                    this.foodPageNum++, "food" == CommConstants.shopCate ? this.getWmFoodListAndCategory(d, null) : this.getScFoodList(d)
                }
            }
        }
    }
...
define('widgets/new_function_tip', ['require'], function(t) {
    ...
    function i(t) {
        this.tipEl = t.tipEl, this.tipContent = t.tipContent, this.tipFlag = t.tipFlag, this.tipTimes = t.tipTimes || 1, this.template = t.oldTemplate ? l : o, this.init()
    }
    var o = "";
    o += '    <div class="roo-tooltip roo-tooltip-bottom" role="tooltip" style="position: absolute;">', o += '        <div class="roo-tooltip-arrow"></div>', o += '        <div class="roo-tooltip-inner tooltip-inner" style="width: 170px; padding-bottom: 30px; line-height: 1.5; font-size: 12px"></div>', o += '        <div style="text-align: right; color: #f8c833; margin-top: -25px; padding-right: 15px;line-height: 1.5">', o += '            <span class="copy" style="cursor: pointer;">我知道了</span>', o += "        </div>", o += "    </div>";
    var l = "";
    return l += '    <div class="tooltip" role="tooltip">', l += '        <div class="tooltip-arrow"></div>', l += '        <div class="tooltip-inner" style="width: 170px; padding-bottom: 30px"></div>', l += '        <div style="text-align: right; color: #f8c833; margin-top: -25px; padding-right: 15px;">', l += '            <span class="copy" style="cursor: pointer;">我知道了</span>', l += "        </div>", l += "    </div>", i.prototype = {
        init: function() {
            var t = localStorage.getItem(this.tipFlag),
                i = this;
            if (!t || !("true" === t || t > this.tipTimes)) {
                var o = ($("." + this.tipEl), $("." + this.tipEl).tooltip({
                    placement: "bottom",
                    title: this.tipContent,
                    template: this.template,
                    trigger: "click"
                }));
                o.tooltip("show"), o.next().find(".copy").on("click", function() {
                    o.tooltip("destroy"), localStorage.setItem(i.tipFlag, t ? ++t : 1)
                }), o.on("click", function() {
                    o.tooltip("destroy"), localStorage.setItem(i.tipFlag, t ? ++t : 1)
                })
            }
        ...
        methods: {
            updatePosition: function(t) {
                var e = document.documentElement,
                    ...
                    f = l - p,
                    g = c - v;
                this.startX = l, this.startY = c, d / 2 + u > o / 2 ? (this.right = Math.max(r - f, 0) + "px", this.left = "auto") : (this.left = Math.max(u + f, 0) + "px", this.right = "auto"), h / 2 + a > i / 2 ? (this.bottom = Math.max(m - g, 0) + "px", this.top = "auto") : (this.top = Math.max(a + g, 0) + "px", this.bottom = "auto")
            },
            onMousedown: function(t) {
                this.mousedown = !0, this.moved = !1, this.downTime = Date.now(), this.startX = t.pageX, this.startY = t.pageY, this.mask && this.addMask()
            },
            onMousemove: function(t) {
                this.moved = !0, this.mousedown && (this.updatePosition(t), this.$emit("drag"))
            },
            onMouseup: function(t) {
                this.mousedown = !1, this.moved ? (this.$el.addEventListener("click", this.preventDefault), this.$emit("drop")) : this.$emit("click", t), this.mask && this.removeMask()
            },
            preventDefault: function(t) {
                t.preventDefault(), t.currentTarget.removeEventListener("click", this.preventDefault)
            },
            addMask: function() {
                var t = document.createElement("div");
                t.id = "draggable-mask", t.style = "position:fixed; top:0; right:0; bottom:0; left:0; background:transparent;", document.body.appendChild(t)
            },
            removeMask: function() {
...
define('module/root/im', ["module/cookie", "util/utils", "module/interface", "util/drag", "widgets/normal_dialog", "widgets/get_poilist", "module/root/im_food_recommend", "widgets/new_function_tip", "components/draggable", "util/request", "module/page_jump"], function(t, e, i, o, n, s, a, r, d, u, c) {
    ...
    function g(a) {
        ...
        var b = location.host,
            w = "";
        w = b.indexOf("test") > -1 ? "/sgcdn/mss_kSA9pkozf0iWTcuco+XPnw==/test07-awp-html-st/set/online_shangou_b_im" : b.indexOf("st") > -1 ? "/sgcdn/mss_5d36254f5d7d4de5ad564fb3bb84682c/awp-html-st/set/online_shangou_b_im" : "/sgcdn/mss_5d36254f5d7d4de5ad564fb3bb84682c/awp-html/set/online_shangou_b_im", l && (h = "//" + location.host + w, p = "sg_im_manifest.json");
        ...
        u.get(v, function(a, u) {
            if ("success" === u) {
                ...
                require.config({
                    ...
                    else var u = [t, e, i, o, n, s, r, d, $, c];
                    a.passMethod(u), a.mount("#sg-im")
                })
            }
        })
    }
    ...
    function t(t, e) {
        ...
        wmNetworkApi.download(o, t, function(t) {
            ...
            if (t.type == n.START) e({
                ...
                t.total == t.completed && (i = !0), e({
                    status: n.DOWNLOADING,
                    progress: a
                })
            } else t.type == n.COMPLETED ? i ? e({
                status: n.COMPLETED
            }) : o() : t.type == n.ERROR && o()
        })
    }
...
define('widgets/sc_normal_dialog', [], function() {
    return function(t) {
        ...
        t.noHeader ? t.noClose || (n += '<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: absolute;top: 10px;right: 10px;z-index: 999;"><span aria-hidden="true">×</span></button>') : n += '<div class="modal-header">' + (t.noClose ? "" : '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>') + '<h5 class="modal-title" id="normalModalLabel">' + t.title + "</h5></div>", n += '<div class="modal-body">' + t.content + '</div><div class="modal-footer">' + (t.btns[0] ? '<button type="button" class="btn btn-default J-confirm">' + t.btns[0].txt + "</button>" : "") + (t.btns[1] ? '<button type="button" class="btn btn-primary J-cancel" data-dismiss="modal">' + t.btns[1].txt + "</button>" : "") + "</div></div></div></div>";
        var s = $(n);
        s.find(".J-confirm").on("click", function() {
            t.btns[0] && t.btns[0].fn ? t.btns[0].fn() : "", s.modal("hide")
        }), s.find(".J-cancel").on("click", function() {
            t.btns[1] && t.btns[1].fn ? t.btns[1].fn() : "", s.modal("hide")
        }), s.on("hide.bs.modal", function(o) {
            t.onClose && t.onClose(), s.remove()
        });
        var l = s.find(".modal-dialog");
        return s.modal("show"), l.css("margin-top", ($(window).height() - l.height()) / 2), s
    }
});
require.config({
    baseUrl: VM.STATIC_URL
    ...
    new Vue({
        ...
        methods: {
            queryLoginTime: function() {
                ...
                $.ajax({
                    ...
                    success: function(o) {
                        ...
                        } else e.$toast.error(o.msg)
                    }
                })
            },
            handleShowGlobalModal: function(e) {
                for (var o = this, t = 0; t < e.length; t++) ! function(t) {
                    var i = e[t] || {};
                    if (i.needShowBox) {
                        ...
                        var n = i.showTimeSeconds || 0,
                            d = 1e3 * n;
                        if (d > 0) var c = setTimeout(function() {
                            o.createModal(i, t), clearTimeout(c)
                        }, d);
                        else var c = setTimeout(function() {
                            o.createModal(i, t), clearTimeout(c)
                        }, 3e3)
                    }
                }(t)
            ...
            confirmShowBoxSuccess: function(e, t) {
                var i = this,
                    a = {};
                "brandId" === t ? a.brandId = e : a.wmPoiId = e, $.ajax({
...
require.config({
    ...
    function a() {
        ...
        if ("http:" === location.protocol) {
            ...
            var i = {
                ...
                a = n ? n.split(",") : ["https://waimaie.meituan.com/static/625fd8c1/imgs/logo.webp", "https://e.waimai.meituan.com/static/625fd8c1/imgs/logo.webp"],
                s = 0,
                m = function() {
                    s === a.length && (i.reportInfo = JSON.stringify(r), $.post("/v2/pc/report/domain/info", i).success(function() {
    ...
    if (d) {
        ...
        S = 3 === y ? O.majorVersion + "." + O.minorVersion : O.release, k = 3 === y ? O.platformId : O.platform, C = O.servicePackMajor
    }
    n(), a()
});
